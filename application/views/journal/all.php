...
//                $('.dataTables_filter input').attr("placeholder", "Search...");
                            ...
                            <div id="page-title" style="overflow: hidden;">
                                <div class="col-md-8">
                                    ...
                                    <p>Add, Edit or Delete Journal Entry</p>
                                </div>
                                <div class="col-md-2 panel-group" id="accordion">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="false" class="collapsed">
                                        <i class="glyph-icon icon-calendar" style="font-size: 200%;padding-left: 110px;"></i>
                                    </a>
                                </div>
                                <div class="col-md-2">
                                    <button class="btn btn-blue-alt pull-right" onclick="AddJournal();"><span style="margin-right: 5px;" class="glyph-icon icon-plus"></span>New Journal Entry</button>
                                </div>
                            </div>
                            <div id="collapseOne" class="panel-collapse collapse" aria-expanded="false">
                                <div class="panel-body">
                                    <div class="row" class="select_date">
                                        <form name="AccountForm" method="post" id="AccountForm" action="<?= base_url() ?>journal/" class="form-horizontal">
                            ...
                            <div class="panel">
                                <div class="panel-body">
                                    <div class="row ">
                                        <a href="<?= base_url() ?>Journal"> <h3 class="title-hero">
                                                All Journal Entries
                                            </h3></a>
                                                ...
                                                if (!empty($journals)): $count = 1;
                                                    foreach ($journals as $journal):
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo html_entity_decode($journal['description']) ?></td>

                                                            <td style="width: 14%;">
                                                            <?php if($this->session->userdata('user_group_id') == 1){ ?>
                                                                <button class="btn btn-round btn-info data-toggle="modal" data-target="#myModal" data-toggle="tooltip" data-placement="top" title="Edit" onclick="EditJournal('<?php echo $journal['journal_id'] ?>');">
                                                                    <i class="glyph-icon icon-pencil"></i>
                                                                </button>
                                                                <button class="btn btn-round btn-danger" data-toggle="tooltip" data-placement="top" title="Delete"  onclick="DeleteJournal('<?php echo $journal['journal_id'] ?>');">
                                                                    <i class="glyph-icon icon-trash"></i>
                                                                </button>
                                                                <?php } ?>  

                                                                <button class="btn btn-round btn-success " data-toggle="tooltip" data-placement="top" title="View"  onclick="ViewJournal('<?php echo $journal['journal_id'] ?>');">
            ...
            <script>
                                                            function EditJournal(journal_id) {
                                                                window.location.href = "<?= base_url() ?>journal/view/" + journal_id;
                                                            ...
                                                            function ViewJournal(journal_id) {
                                                                window.location.href = "<?= base_url() ?>journal/view_journal/" + journal_id;
                                                            }

                                                            function DeleteJournal(journal_id) {
                                                                var cnfirm = confirm("Are You Sure?");
                                                                if (cnfirm) {
                                                                    $.post("<?= base_url() ?>journal/delete", {id: journal_id})
                                                                            .done(function (data) {
//                                                                                    alert(data);
                                                                                if ($.trim(data) == 'done') {
                                                            ...
                                                            function AddJournal() {
                                                                window.location.href = "<?= base_url() ?>journal/add";
                                                            }
                ...
                $("#search").keyup(function (event) {
                    ...
                    if (keycode == '13') {
                        ...
                        if (rtngPtId == "") {
                            ...
                            $.post("<?= base_url() ?>Journal/search", {id: rtngPtId})
                                    .done(function (data) {
