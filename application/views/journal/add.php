...
<!--<link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/widgets/chosen/chosen.css">-->
            ...
            // });
                            ...
                            <div id="page-title">
                                ...
                                <p>Enter Details of Amount Transfer from One Account to Other</p>
                            ...
                            <div class="panel">
                                <div class="panel-body">
                                    ...
                                    <div class="example-box-wrapper">
                                        <form method="post" action="<?= base_url() ?>journal/add" id="SubmitAdd" class="form-horizontal bordered-row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <select name="from_account" onchange="Validation()" id="from_account" class="chosen-select">
                                                        <option value="">Select Option</option>
                                                        <option value="0">Cash Book</option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <select name="to_account" onchange="Validation()" id="to_account" class="chosen-select">
                                                        <option value="">Select Option</option>
                                                        <option value="0">Cash Book</option>
                                                        <?php foreach ($accounts as $account) { ?>
                                                            <option value="<?= $account->account_id ?>"><?= $account->account_name ?></option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="amount" onkeyup="Validation()" id="amount" class="form-control" placeholder="Amount in Rs">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="input-group"> 
                                                    <input type="text" name="jv_no" id="jv_no" class="form-control" value="<?= $last_journal_no ?>" readonly="" >
                                                    </div> 
                                            </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <button class="btn btn-alt btn-hover btn-blue-alt col-md-4" onclick="return ConfirmAdd();">
                                                    <span>CONFIRM ADD NEW JOURNAL ENTRY</span>
                                                    <i class="glyph-icon icon-arrow-right"></i>
                                                </button>
                                                <div class="col-md-4 col-sm-0"></div>
                                            </div>
