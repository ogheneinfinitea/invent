...
<!--<link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/widgets/chosen/chosen.css">-->
                            ...
                            <div id="page-title">
                                ...
                                <p>Edit details of amount Transfer from one account to other</p>
                            ...
                            <div class="panel">
                                <div class="panel-body">
                                    ...
                                    <div class="example-box-wrapper">
                                        <form method="post" action="<?= base_url() ?>journal/edit" id="SubmitAdd" class="form-horizontal bordered-row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <select name="from_account" id="from_account" class="chosen-select">
                                                        <option value="">Select Option</option>
                                                        <option <?= $journal[0]->from_account == "0" ? "selected" : "" ?> value="0">Cash Book</option>
                                                        <?php foreach ($accounts as $account) { ?>
                                                            <option <?= $journal[0]->from_account == $account->account_id ? "selected" : "" ?> value="<?= $account->account_id ?>"><?= $account->account_name ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                            </div>
                                            <input type="hidden" name="journal_id" value="<?= $journal[0]->journal_id ?>" />
                                            <input type="hidden" name="CPV" value="<?= $journal[0]->CPV ?>" />
                                            <input type="hidden" name="CRV" value="<?= $journal[0]->CRV ?>" />
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label">To Account</label>
                                                <div class="col-sm-6">
                                                    <select name="to_account" id="to_account" class="chosen-select">
                                                        <option value="">Select Option</option>
                                                        <option <?= $journal[0]->to_account == "0" ? "selected" : "" ?> value="0">Cash Book</option>
                                                        <?php foreach ($accounts as $account) { ?>
                                                            <option <?= $journal[0]->to_account == $account->account_id ? "selected" : "" ?> value="<?= $account->account_id ?>"><?= $account->account_name ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="input-group">
                                                        <span class="input-group-addon" style="font-size: 10px; font-weight: bold;">Rs</span>
                                                        <input value="<?= $journal[0]->amount ?>" type="text" name="amount" id="amount" class="form-control" placeholder="Amount in Rs">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label">Journal Voucher No</label>
                                                <div class="col-sm-6">
                                                    <input type="text" name="jv_no" id="jv_no" class="form-control" value="<?= $journal[0]->voucher_no ?>" readonly="" >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-12">
                                                    <textarea name="desc" id="desc"><?= $journal[0]->description ?></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="col-md-4 col-sm-0"></div>
                                                <button class="btn btn-alt btn-hover btn-blue-alt col-md-4" onclick="return ConfirmEdit();">
                                                    <span>CONFIRM EDIT JOURNAL ENTRY</span>
                                                    <i class="glyph-icon icon-arrow-right"></i>
                                                </button>
                                                <div class="col-md-4 col-sm-0"></div>
                                            </div>
            ...
            <script>
                function ConfirmAdd() {
                    ...
                    if (from_account == "" || from_account == null) {
                        $("#from_account_chosen").css("border", "1px solid red");
                        err = true;
                    }
                    if (to_account == "" || to_account == null) {
                        $("#to_account_chosen").css("border", "1px solid red");
                        err = true;
                    }
