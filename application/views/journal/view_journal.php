                ...
                <div id="page-content-wrapper">
                    <div id="page-content">
                        ...
                        <div class="container">
                            ...
                            <div id="page-title">
                                <h2>Journal View Slip</h2>
                                <p>Please check Journal</p>
                            ...
                            <script>
                                function printjournal() {
                                    window.location.href = "<?= base_url() ?>journal/print_journal/<?= $journal[0]->journal_id ?>";
                                   // window.print();
                                        }
                                     
                                                function canceljournal() {
                                                    window.location.href = "<?= base_url() ?>journal";
//                                    window.print();
                                                }
                            </script>
                            <div class="content-box pad25A">
                                <div class="row">
                                    ...
                                    <div class="col-sm-8 float-right text-right">
                                        <h4 class="invoice-title">Journals Slip</h4>
                                        No. <b>#<?= $journal[0]->journal_id ?></b>
                                        <div class="divider"></div>
                                        <div class="invoice-date mrg20B"><?= date("j F Y", strtotime($journal[0]->date)) ?></div>
                                       
                                        <button onclick="printjournal()" class="btn btn-alt btn-hover btn-info">
                                            <span>Print Journal</span>
                                            <i class="glyph-icon icon-print"></i>
                                        </button>
                                        <button onclick="canceljournal()" class="btn btn-alt btn-hover btn-danger">
                                            <span>Cancel</span>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <h2 class="invoice-client mrg10T">From Client info</h2>
                                    ...
                                    <div class="col-md-4">
                                        <h2 class="invoice-client mrg10T">To Client info:</h2>
                                    ...
                                    <div class="col-md-4">
                                        <h2 class="invoice-client mrg10T">journals Info:</h2>
                                        <ul class="reset-ul">
                                ...
                                <table class="table mrg20T table-hover">
                                    ...
                                    <tr>
                                        <td style="text-align: right;">Amount In Words:  <b><?= getPakistaniCurrency($word) ?></b></td>
                                    </tr>
