...
<!-- ////////////////Account Haeding/ And Add Page///////////////////////////// -->
        ...
        <div id="page-title">
            ...
            <h2>Add Information for Account</h2>
        ...
        <div class="panel">
            <div class="panel-body">
                                    ...
                                    <div class="example-box-wrapper">
                                        <form method="post" action="<?= base_url() ?>accounts/add" id="SubmitAdd" class="form-horizontal bordered-row">
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label">Account Name</label>
                                                <div class="col-sm-6">
                                                    <div class="input-group">
                                                        <span class="input-group-addon glyph-icon icon-male"></span>
                                                        <input type="text" name="name" onkeyup="RevertValidation()" id="name" class="form-control" placeholder="Full Name">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="account_number" onkeyup="RevertValidation()"  id="account_number" class="form-control" placeholder="Account Number" value="<?= $account_number ? sprintf('%04d', $account_number[0]->account_number + 1) : '' ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="input-group">
                                                        ...
                                                        <input name="account_address"  type="text" id="account_address" class="form-control" placeholder="Address" >
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="input-group">
                                                        <span class="input-group-addon glyph-icon icon-phone"></span>
                                                        <input name="phone_number" onkeyup="RevertValidation()" type="text" id="phone_number" class="form-control" placeholder="Phone Number">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="input-group">
                                                        <span class="input-group-addon" style="font-weight: bold; font-size: 10px;">N</span>
                                                        <input name="opening_balance" onkeyup="RevertValidation()" type="text" id="opening_balance" class="form-control" placeholder="Opening Balance">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                    <select name="account_type" onchange="RevertValidation()" id="account_type" class="chosen-select ">
                                                        ...
                                                        <?php foreach ($account_type as $account_type) { ?>
                                                            <option value="<?= $account_type->account_type_id ?>"><?= $account_type->account_type ?></option>
                                                        <?php } ?>
                                                    </select>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <button class="btn btn-alt btn-hover btn-blue-alt col-md-4" onclick="return ConfirmAdd();">
                                                    <span>CONFIRM ADD NEW ACCOUNT</span>
                                                    <i class="glyph-icon icon-arrow-right"></i>
                                                </button>
                                                <div class="col-md-4 col-sm-0"></div>
                                            </div>
    ...
    <!-- ////////////////Script Add Confirm & Validation Start///////////////////////////// -->
            ...
            <script>
                function ConfirmAdd() {
                    ...
                    //     $("#account_address").css("border", "1px solid red");
                    //     err = true;
                    // }
