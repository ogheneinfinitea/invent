...
<!--<link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/widgets/chosen/chosen.css">-->
                            ...
                            <div id="page-title">
                                <h2>Update Information for Account (<?= $account[0]->account_name ?>)</h2>
                            ...
                            <div class="panel">
                                <div class="panel-body">
                                    ...
                                    <div class="example-box-wrapper">
                                        <form method="post" action="<?= base_url() ?>accounts/edit" id="SubmitAdd" class="form-horizontal bordered-row">
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label">Account Name</label>
                                                <div class="col-sm-6">
                                                    <div class="input-group">
                                                        <span class="input-group-addon glyph-icon icon-male"></span>
                                                        <input value="<?= $account[0]->account_name ?>" type="text" name="name" id="name" class="form-control" placeholder="Full Name">
                                                    </div>
                                                </div>
                                            </div>
                                            <input type="hidden" name="account_id" value="<?= $account[0]->account_id ?>" />
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label">Account Number</label>
                                                <div class="col-sm-6">
                                                    <div class="input-group">
                                                        <span class="input-group-addon glyph-icon icon-sort-numeric-asc"></span>
                                                        <input readonly="" value="<?= $account[0]->account_number ?>" type="text" name="account_number" id="account_number" class="form-control" placeholder="Account Number">
                                                    </div>
                                                </div>
                                            </div>
                                            
                                              <div class="form-group">
                                                <label class="col-sm-3 control-label">Account Address</label>
                                                <div class="col-sm-6">
                                                    <div class="input-group">
                                                        <span class="input-group-addon glyph-icon icon-phone"></span>
                                                        <input value="<?= $account[0]->account_address ?>" name="account_address" type="text" id="account_address" class="form-control" placeholder="Account Address">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="input-group">
                                                        <span class="input-group-addon glyph-icon icon-phone"></span>
                                                        <input value="<?= $account[0]->ph_number ?>" name="phone_number" type="text" id="phone_number" class="form-control" placeholder="Phone Number">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="input-group">
                                                        <span class="input-group-addon" style="font-weight: bold; font-size: 10px;">Rs</span>
                                                        <input value="<?= $account[0]->opening_balance ?>" name="opening_balance" type="text" id="opening_balance" class="form-control" placeholder="Opening Balance">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-6">
                                                    <select name="account_type" onchange="RevertValidation()" id="account_type" class="chosen-select ">
                                                        <option value="" Select Option </option>
                                                        <?php foreach ($account_type as $account_type) { ?>
                                                            <option <?= $account[0]->account_type ==$account_type->account_type_id ?"selected":""?> value="<?= $account_type->account_type_id ?>"><?= $account_type->account_type ?></option>
                                                        <?php } ?>
                                                    </select>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-12">
                                                    <textarea name="desc" id="desc"><?= $account[0]->description ?></textarea>
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                <div class="col-md-4 col-sm-0"></div>
                                                <button class="btn btn-alt btn-hover btn-blue-alt col-md-4" onclick="return ConfirmUpdate();">
                                                    <span>CONFIRM UPDATE ACCOUNT</span>
                                                    <i class="glyph-icon icon-arrow-right"></i>
                                                </button>
                                                <div class="col-md-4 col-sm-0"></div>
                                            </div>
            ...
            <script>
                function ConfirmUpdate() {
                    ...
                    if (opening_balance == "" || opening_balance == null) {
                        $("#opening_balance").css("border", "1px solid red");
                        err = true;
                    }
                    if (err === true) {
                        return false;
