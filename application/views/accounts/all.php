...
//                $('.dataTables_filter input').attr("placeholder", "Search...");
                            ...
                            <div id="page-title" style="overflow: hidden;">
                                <div class="col-md-6">
                                    <h2>Accounts</h2>
                                    <p>Add, Edit or Delete Accounts</p>
                                </div>
                                <div class="col-md-6">
                                    <button class="btn btn-blue-alt pull-right" onclick="AddAcount();"><span style="margin-right: 5px;" class="glyph-icon icon-plus"></span>Add Account</button>
                                </div>
                            </div>
                            ...
                            <div class="panel">
                                <div class="panel-body">
                                    <div class="row ">
                                        <a href="<?= base_url() ?>Accounts"><h3 class="title-hero col-md-9">
                                                All Accounts
                                            </h3></a>
                                                    ...
                                                    foreach ($accounts as $account) :
                                                        ...
                                                        <tr>
                                                            ...
                                                            <?php if($this->session->userdata('user_group_id') == 1){ ?>
                                                                ...
                                                                <button class="btn btn-round btn-info" data-toggle="tooltip" data-placement="top" title="Edit" data-toggle="modal" data-target="#myModal" onclick="EditAccount('<?= $account['account_id'] ?>');">
                                                                    <i class="glyph-icon icon-pencil"></i>
                                                                </button>
                                                                <button class="btn btn-round btn-danger" data-toggle="tooltip" data-placement="top" title="Delete" onclick="DeleteAccount('<?= $account['account_id'] ?>');">
            ...
            <script>
                                                            ...
                                                            function EditAccount(account_id) {
                                                                window.location.href = "<?= base_url() ?>accounts/view/" + account_id;
                                                            }
                                                            function DeleteAccount(account_id) {
                                                                var cnfirm = confirm("Are You Sure?");
                                                                if (cnfirm) {
                                                                    $.post("<?= base_url() ?>accounts/delete", {id: account_id})
                                                                            .done(function (data) {                                                                                 
                                                                                if ($.trim(data) == 'done') {
                                                            ...
                                                            function AddAcount() {
                                                                window.location.href = "<?= base_url() ?>accounts/add";
                                                            }
                ...
                $("#search").keyup(function (event) {
                    ...
                    if (keycode == '13') {
                        ...
                        if (rtngPtId == "") {
                            ...
                            $.post("<?= base_url() ?>Accounts/search", {id: rtngPtId})
                                    .done(function (data) {
