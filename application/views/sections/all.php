    ...
    $(document).ready(function () {
        $('.dataTables_filter input').attr("placeholder", "Search...");
                            ...
                            <div id="page-title" style="overflow: hidden;">
                                <div class="col-md-6">
                                    <h2>Sections</h2>
                                    <p>Add, Edit or Delete Sections</p>
                                </div>
                                <div class="col-md-6">
                                    <button class="btn btn-blue-alt pull-right" onclick="AddUser();"><span style="margin-right: 5px;" class="glyph-icon icon-plus"></span>Add Section</button>
                                </div>
                            </div>
...
<tr>
    ...
    <th>Manage</th>
                                                ...
                                                <?php foreach ($sections as $section) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php if($this->session->userdata('user_group_id') == 1){ ?>
                                                            <button class="btn btn-round btn-info" data-toggle="tooltip" data-placement="top" title="Edit" data-toggle="modal" data-target="#myModal" onclick="EditSection('<?= $section->section_id ?>');">
                                                                <i class="glyph-icon icon-pencil"></i>
                                                            </button>
                                                            <button class="btn btn-round btn-danger" data-toggle="tooltip" data-placement="top" title="Delete" onclick="DeleteSection('<?= $section->section_id ?>');">
                                                                <i class="glyph-icon icon-trash"></i>
                                                            </button>
                                                        <?php } ?>    
                                                            <button onclick="GoLedger('<?= $section->section_id ?>');"  class="btn btn-round btn-success" >
            ...
            <script>
                                                            function EditSection(unit_id) {
                                                                window.location.href = "<?= base_url() ?>sections/view/" + unit_id;
                                                            ...
                                                            function DeleteSection(unit_id) {
                                                                var cnfirm = confirm("Are You Sure?");
                                                                if (cnfirm) {
                                                                    $.post("<?= base_url() ?>sections/delete", {id: unit_id})
                                                                            .done(function (data) {
//                                                                                    alert(data);
                                                                                if ($.trim(data) == 'done') {
                                                            ...
                                                            function AddUser() {
                                                                window.location.href = "<?= base_url() ?>sections/add";
                                                            }
                                                            function GoLedger(section_id) {
//                                                                alert(curr_date);
                                                                $.post("<?= base_url() ?>" + "reports/section_statement", {section: section_id, from_date: curr_date, to_date: curr_date})
                                                                        .done(function (data) {
//                                                                            console.log(data);
//                                                                            return false;
