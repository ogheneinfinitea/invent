...
<html  lang="en">
    ...
    <head>
        ...
        <!--[if IE]><meta http-equiv='X-UA-Compatible' content='IE=edge,chrome=1'><![endif]-->
            <title> Facteezo: Product Category </title>
            ...
            $(document).ready(function () {
                $('.dataTables_filter input').attr("placeholder", "Search...");
                            ...
                            <div id="page-title" style="overflow: hidden;">
                                ...
                                <div class="col-md-6">
                                    <button class="btn btn-blue-alt pull-right" onclick="AddUser();"><span style="margin-right: 5px;" class="glyph-icon icon-plus"></span>Add Product Category</button>
                                </div>
                            </div>
...
<tr>
    ...
    <th>Manage</th>
                                            ...
                                            <tbody>
                                                <?php foreach ($product_categories as $product_category) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?= $product_category->symbol ?></td>

                                                        <td>
                                                        <?php if($this->session->userdata('user_group_id') == 1){ ?>
                                                            <button class="btn btn-round btn-info" data-toggle="modal" data-target="#myModal" data-toggle="tooltip" data-placement="top" title="Edit" onclick="EditProductCategory('<?= $product_category->product_category_id ?>');">
                                                                <i class="glyph-icon icon-pencil"></i>
                                                            </button>
                                                            <button class="btn btn-round btn-danger" data-toggle="tooltip" data-placement="top" title="Delete" onclick="DeleteProductCategory('<?= $product_category->product_category_id ?>');">
            ...
            <script>
                                                            function EditProductCategory(product_category_id) {
                                                                window.location.href = "<?= base_url() ?>product_category/view/" + product_category_id;
                                                            ...
                                                            function DeleteProductCategory(product_category_id) {
                                                                ...
                                                                if (cnfirm) {
                                                                    $.post("<?= base_url() ?>product_category/delete", {id: product_category_id})
                                                                            .done(function (data) {
//                                                                                    alert(data);
                                                                                if ($.trim(data) == 'done') {
                                                            ...
                                                            function AddUser() {
                                                                window.location.href = "<?= base_url() ?>product_category/add";
                                                            }
