...
<!--<link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/widgets/chosen/chosen.css">-->
                            ...
                            <div id="page-title">
                                <h2>Edit Unit</h2>
                                <p>Update Name or Symbol for Unit</p>
                            ...
                            <div class="panel">
                                <div class="panel-body">
                                    ...
                                    <div class="example-box-wrapper">
                                        <form method="post" action="<?= base_url() ?>product_category/edit" id="SubmitEdit" class="form-horizontal bordered-row">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="name" id="name" value="<?= $product_category[0]->product_category_name ?>" class="form-control" placeholder="Product Category Name">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="input-group">
                                                        <span class="input-group-addon glyph-icon icon-key"></span>
                                                        <input type="text" name="symbol" id="symbol" value="<?= $product_category[0]->symbol ?>" class="form-control" placeholder="Symbol">
                                                    </div>
                                                </div>
                                            </div>
                                            <input type="hidden" name="product_category_id" value="<?= $product_category[0]->product_category_id ?>" />
