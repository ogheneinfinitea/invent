                            ...
                            <div class="panel">
                                <div class="panel-body">
                                    ...
                                    <div class="example-box-wrapper">
                                        <form method="post" action="<?= base_url() ?>process/edit" id="SubmitAdd" class="form-horizontal bordered-row" onsubmit="return validation_for_raw_metrial();">
...
//                                                        print_r($inv_item->qty);
                                                        $html .= '<div class="col-sm-12 prod_raw" id="raw' . $raw_id . '"><div class="col-sm-4">';
