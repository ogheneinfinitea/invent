...
<html  lang="en">
    ...
    <head>
        ...
        <script>
            function print_me() {
                window.print();
                window.location.href = "<?= base_url() ?>process/view_slip/<?= $issue[0]->issue_id ?>";
                    }
        </script>
        ...
        <table width="100%">
            <tr>
                <td colspan="3" width="30%">
                    <div class="">
                        <img style="height: 80px" src="<?= base_url() ?>/images/Kohinoor_logo.png" />
                    </div>
                    <address class="invoice-address">
                    </address>
                </td>
                <td colspan="6" class="text-right " valign="top">
                    <h4 class="invoice-title" style="font-size: 22px">Process Slip</h4>
