                ...
                <div id="page-content-wrapper">
                    <div id="page-content">
                        ...
                        <div class="container">
                            ...
                            <script>
                                function printordr() {
                                    window.location.href = "<?= base_url() ?>Purchase_order/print_inv/<?= $ordr[0]->ordr_id ?>";
//                                    window.print();
                                        }
                                        function printGatepass() {
                                            window.location.href = "<?= base_url() ?>Purchase_order/print_gatepass/<?= $ordr[0]->ordr_id ?>";
//                                    window.print();
                                                }
                                                function cancelordr() {
                                        ...
                                        foreach ($ordr_items as $ordr_item) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><?= $ordr_item->qty . " " . $ordr_item->unit ?></td>
                                                                                                <!-- <td class="text-center"><?= $ordr_item->product_Purchase_price ?> Rs</td>
