                ...
                $('.bootstrap-datepicker').bsdatepicker({
                    format: 'mm-dd-yyyy'
                            ...
                            <div id="page-title">
                                ...
                                <p>Change Required information for Return Purchase</p>
...
//                echo $key . "<br>";
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <div id="tot_dis" class="col-sm-2" style="font-size: 20px; font-weight: bold;"><span><?= $ordr[0]->total_discount ?></span> Rs</div>
                                                    <div id="total" class="col-sm-3" style="font-size: 22px; font-weight: bold; color:#003eff;"><span><?= $ordr[0]->ordr_total ?></span> Rs
...
//                                                    alert($("#product_name" + id).next("div").children("a").text());
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-2">
                                                    <input  type="text" name="sv_no" value="<?= $ordr[0]->voucher_no ?>" id="sv_no" class="form-control" Readonly="">
                                                </div>
                                            ...
                                            <input type="hidden" name="ordr_no" value="<?= $ordr[0]->ordr_no ?>"/>
                                            <div class="form-group">
