...
<!--<link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/widgets/chosen/chosen.css">-->
                            ...
                            <div id="page-title">
                                ...
                                <p>Add Number and Select Product for Batch</p>
                            ...
                            <div class="panel">
                                <div class="panel-body">
                                    ...
                                    <div class="example-box-wrapper">
                                        <form method="post" action="<?= base_url() ?>batch/edit/<?= $batch[0]->batch_id ?>" id="SubmitAdd" class="form-horizontal bordered-row">
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label">Batch Number</label>
                                                <div class="col-sm-6">
                                                    <div class="input-group">
                                                        <span class="input-group-addon glyph-icon icon-circle-o"></span>
                                                        <input type="text" name="number" id="number" class="form-control" placeholder="Batch No" value="<?= $batch[0]->batch_no ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <select onchange="add_units(this.options[this.selectedIndex].getAttribute('unit_symbol'))" name="product" id="product" class="chosen-select">
                                                        <option value="">Select Option</option>
                                                        <?php foreach ($products as $product) { ?>
                                                            <option <?= $batch[0]->product_id == $product->product_id ? 'selected' : '' ?>  unit_symbol="<?= $product->unit_symbol ?>" value="<?= $product->product_id ?>"><?= $product->product_name ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="input-group" id="div_qty">
                                                        ...
                                                        <input type="number" name="qty" id="qty" class="form-control" placeholder="Max Qty" value="<?= $batch[0]->max_qty ?>">
            ...
            <script>
                                                    ...
                                                    function add_units(unit_symbol) {
                                                        ...
                                                        $("#div_qty span").remove();
                                                        // alert(unit_symbol);
                                                        $("#div_qty").append('<span class="input-group-addon bootstrap-touchspin-postfix">' + unit_symbol + '</span>');
