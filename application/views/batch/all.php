            ...
            $(document).ready(function () {
                $('.dataTables_filter input').attr("placeholder", "Search...");
                            ...
                            <div id="page-title" style="overflow: hidden;">
                                <div class="col-md-6">
                                    <h2>Batches</h2>
                                    <p>Add, Edit or Delete Batches</p>
                                </div>
                                <div class="col-md-6">
                                    <button class="btn btn-blue-alt pull-right" onclick="AddBatch();"><span style="margin-right: 5px;" class="glyph-icon icon-plus"></span>Add Batch</button>
                                </div>
                            </div>
    ...
    <th>Manage</th>
                                                ...
                                                <?php foreach ($batches as $batch) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php if($this->session->userdata('user_group_id') == 1){ ?>    
                                                            <button class="btn btn-round btn-info" data-toggle="tooltip" data-placement="top" title="Edit" data-toggle="modal" data-target="#myModal" onclick="EditBatch('<?= $batch->batch_id ?>');">
                                                                <i class="glyph-icon icon-pencil"></i>
                                                            </button>
                                                            <button class="btn btn-round btn-danger" data-toggle="tooltip" data-placement="top" title="Delete" onclick="DeleteBatch('<?= $batch->batch_id ?>');">
            ...
            <script>
                                                                function EditBatch(batch_id) {
                                                                    window.location.href = "<?= base_url() ?>batch/view/" + batch_id;
                                                                ...
                                                                function DeleteBatch(batch_id) {
                                                                    ...
                                                                    if (cnfirm) {
                                                                        $.post("<?= base_url() ?>batch/delete", {id: batch_id})
                                                                                .done(function (data) {
//                                                                                    alert(data);
                                                                                    if ($.trim(data) == 'done') {
                                                                ...
                                                                function AddBatch() {
                                                                    window.location.href = "<?= base_url() ?>batch/add";
                                                                }
