...
<html  lang="en">
    ...
    <head>
        ...
        <script>
            function print_me() {
                window.print();
                window.location.href = "<?= base_url() ?>production/view_slip/<?= $issue[0]->issue_id ?>";
                    }
        </script>
    ...
    <body onload="print_me();">
        <table width="100%">
            <tr>
                <td colspan="3" width="30%">
                    <div class="">
                        <img style="height: 70px" src="<?= base_url() ?>/images/Kohinoor_logo.png" />
                    </div>
                    <address class="invoice-address">
                    </address>
                </td>
                <td colspan="6" class="text-right " valign="top">
                    <h4 class="invoice-title" style="font-size: 22px">Production Slip</h4>
        ...
        <table width="100%">
            <tr>
                <td colspan="4">
                    <h2 class="invoice-client ">Receiver information:</h2>
