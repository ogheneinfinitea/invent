...
<html  lang="en">
    ...
    <head>
        ...
        <title> Facteezo: Production Slip </title>
                    ...
                    <div id="page-content">
                        ...
                        <div class="container">
                            ...
                            <div id="page-title">
                                ...
                                <p>Please check Production Slip</p>

                            </div>

                            <script>
                                function printInvoice() {
                                    window.location.href = "<?= base_url() ?>production/print_slip/<?= $issue[0]->issue_id ?>";
//                                    window.print();
                                        }
                            ...
                            <div class="content-box pad25A">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 float-right text-right">
                                        <h4 class="invoice-title">Production Slip</h4>
