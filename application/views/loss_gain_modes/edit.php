...
<!--<link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/widgets/chosen/chosen.css">-->
                            ...
                            <div id="page-title">
                                <h2>Edit Loss / Gain Mode</h2>
                                <p>Update Name for  Loss / Gain Mode </p>
                            ...
                            <div class="panel">
                                <div class="panel-body">
                                    ...
                                    <div class="example-box-wrapper">
                                        <form method="post" action="<?= base_url() ?>loss_gain_modes/edit" id="SubmitEdit" class="form-horizontal bordered-row">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="loss_gain_mode" id="loss_gain_mode" value="<?= $loss_gain_modes[0]->loss_gain_mode ?>" class="form-control" placeholder="Product Category Name">
                                                    </div>
                                                </div>
                                            </div>

                                            <input type="hidden" name="loss_gain_mode_id" value="<?= $loss_gain_modes[0]->loss_gain_mode_id ?>" />

                                            <div class="form-group">
                                                <div class="col-md-4 col-sm-0"></div>
                                                <button class="btn btn-alt btn-hover btn-blue-alt col-md-4" onclick="return ConfirmEdit();">
                                                    <span>CONFIRM EDIT LOSS/GAIN MODE</span>
                                                    <i class="glyph-icon icon-arrow-right"></i>
                                                </button>
                                                <div class="col-md-4 col-sm-0"></div>
                                            </div>
