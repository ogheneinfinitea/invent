...
<!--<link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/widgets/chosen/chosen.css">-->
                            ...
                            <div id="page-title">
                                <h2>Add a new Loss / Gain Mode</h2>
                                <p>Add Name for Loss / Gain Mode</p>
                            ...
                            <div class="panel">
                                <div class="panel-body">
                                    ...
                                    <div class="example-box-wrapper">
                                        <form method="post" action="<?= base_url() ?>loss_gain_modes/add" id="SubmitAdd" class="form-horizontal bordered-row">
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label">Loss Gain Mode Name</label>
                                                <div class="col-sm-6">
                                                    <div class="input-group">
                                                        <span class="input-group-addon glyph-icon icon-circle-o"></span>
                                                        <input type="text" name="loss_gain_mode" onkeyup="Validation()" id="loss_gain_mode" class="form-control" placeholder="Loss / Gain Mode Name">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <button class="btn btn-alt btn-hover btn-blue-alt col-md-4" onclick="return ConfirmAdd();">
                                                    <span>CONFIRM ADD NEW Loss / Gain Mode</span>
                                                    <i class="glyph-icon icon-arrow-right"></i>
                                                </button>
                                                <div class="col-md-4 col-sm-0"></div>
                                            </div>
            ...
            <script>
            function ConfirmAdd() {
                var loss_gain_mode = $("#loss_gain_mode").val();
                var err = false;
                if (loss_gain_mode == "" || loss_gain_mode == null) {
                    $("#loss_gain_mode").css("border", "1px solid red");
                    err = true;
                }
                if (err === true) {
                    return false;
             ...
             function Validation() {
                ...
                var err = false;
                if (loss_gain_mode !== "" & loss_gain_mode !== null) {
                    $("#loss_gain_mode").css("border", "1px solid #dfe8f1");
                    err = true;
                }
                // if (err === true) {
                //     return false;
