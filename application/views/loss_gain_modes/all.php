...
<html  lang="en">
    ...
    <head>
        ...
        <!--[if IE]><meta http-equiv='X-UA-Compatible' content='IE=edge,chrome=1'><![endif]-->
          <title> Facteezo: Loss/ Gain Modes </title>
...
<!--<link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/widgets/datatable/datatable.css">-->
            ...
            $(document).ready(function () {
                $('.dataTables_filter input').attr("placeholder", "Search...");
                            ...
                            <div id="page-title" style="overflow: hidden;">
                                <div class="col-md-6">
                                    <h2>Loss / Gain Modes</h2>
                                    <p>Add, Edit or Delete Loss / Gain Modes</p>
                                </div>
                                <div class="col-md-6">
                                    <button class="btn btn-blue-alt pull-right" onclick="AddUser();"><span style="margin-right: 5px;" class="glyph-icon icon-plus"></span>Add Loss / Gain Mode</button>
                                </div>
                            </div>
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="example-box-wrapper">
                                        <table id="datatable-responsive" class="table table-striped table-bordered responsive no-wrap" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                <?php foreach ($loss_gain_modes as $loss_gain_mode) {
                                                    ?>
                                                    <tr>
                                                        <td><?= $loss_gain_mode->loss_gain_mode_id ?></td>
                                                        <td><?= $loss_gain_mode->loss_gain_mode ?></td>

                                                        <td>
                                                    <?php if($this->session->userdata('user_group_id') == 1){ ?>
                                                            <button class="btn btn-round btn-info" data-toggle="tooltip" data-placement="top" title="Edit" data-toggle="modal" data-target="#myModal" onclick="EditProductCategory('<?= $loss_gain_mode->loss_gain_mode_id ?>');">
                                                                <i class="glyph-icon icon-pencil"></i>
                                                            </button>
                                                            <button class="btn btn-round btn-danger" data-toggle="tooltip" data-placement="top" title="Delete" onclick="DeleteProductCategory('<?= $loss_gain_mode->loss_gain_mode_id ?>');">
            ...
            <script>
                                                            function EditProductCategory(loss_gain_mode_id) {
                                                                window.location.href = "<?= base_url() ?>loss_gain_modes/view/" + loss_gain_mode_id;
                                                            ...
                                                            function DeleteProductCategory(loss_gain_mode_id) {
                                                                var cnfirm = confirm("Are You Sure?");
                                                                if (cnfirm) {
                                                                    $.post("<?= base_url() ?>loss_gain_modes/delete", {id: loss_gain_mode_id})
                                                                            .done(function (data) {
//                                                                                    alert(data);
                                                                                if ($.trim(data) == 'done') {
                                                            ...
                                                            function AddUser() {
                                                                window.location.href = "<?= base_url() ?>loss_gain_modes/add";
                                                            }
