...
<html  lang="en">
    ...
    <head>
        ...
        <title> Facteezo: Product Adjustment </title>
                    ...
                    <div id="page-content">
                        ...
                        <div class="container">
                            ...
                            <div id="page-title">
                                ...
                                <p>Please check Adjustment</p>

                            </div>

                            <script>
                                function printadjustment() {
                                    window.location.href = "<?= base_url() ?>product_adjustment/print_adjustment/<?= $product_ledger[0]->product_ledger_id ?>";
                                   // window.print();
                                        }

                                                function canceladjustment() {
                                                    window.location.href = "<?= base_url() ?>product_adjustment";
                            ...
                            <div class="content-box pad25A">
                                <div class="row">
                                    ...
                                    <div class="col-sm-8 float-right text-right">
                                        <h4 class="invoice-title">Adjustment</h4>
                                        No. <b>#<?= $product_ledger[0]->product_ledger_id ?></b>
                                        <div class="divider"></div>
                                        <div class="invoice-date mrg20B"><?= date("j F Y", strtotime($product_ledger[0]->date_ledger)) ?></div>
                                        <!-- <button onclick="printGatepass()" class="btn btn-alt btn-hover btn-success">
                                            <span>Print Gate Pass</span>
                                            <i class="glyph-icon icon-print"></i>
                                        </button> -->
                                        <button onclick="printadjustment()" class="btn btn-alt btn-hover btn-info">
                                            <span>Print Adjustment</span>
                                            <i class="glyph-icon icon-print"></i>
                                        </button>
                                        <button onclick="canceladjustment()" class="btn btn-alt btn-hover btn-danger">
                                            <span>Cancel Adjustment</span>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <h2 class="invoice-client mrg10T">Product information:</h2>
                                        <h5><?= $product_ledger[0]->product_name ?></h5>
                                        <address class="invoice-address">
                                       
                                        </address>
                                    </div>
                                    <div class="col-md-4">
                                        <h2 class="invoice-client mrg10T">Adjustment Info:</h2>
                                        <ul class="reset-ul">
                                            <li><b>Date:</b><?= date("F j, Y", strtotime($product_ledger[0]->date_ledger)) ?></li>
                                            ...
                                            <li><b>Id:</b> #<?= $product_ledger[0]->product_ledger_id ?></li>
                                        </ul>
                                    </div>
                                    <div class="col-md-4">
                                        <h2 class="invoice-client mrg10T">Adjustment Details:</h2>
                                        <!-- <?= html_entity_decode($ledger[0]->voucher_no) ?> -->
                                    </div>
                                </div>

                                <table class="table mrg20T table-hover" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>Description</th>
                                    ...
                                    <tbody>
                                        <?php
                                        $counter = 1;
                                        foreach ($product_ledger as $product_ledger) {
                                            ?>
                                            <tr>
                                                <td><?= $counter ?></td>
                                                <td><?= $product_ledger->product_ledger_desc ?></td>
                                                <td class="text-center"><?= ($product_ledger->credit_qty!='0.00')?$product_ledger->credit_qty: $product_ledger->debit_qty ?>Unit</td>
                                            </tr>
                                            <?php
                                            $counter++;
                                        }
                                  ...
                                  <!--           <td colspan="1" class="text-right font-size-20">TOTAL:</td> -->
                                           <!--  <?php $amount = $ledger[0]->amount; ?>
                                            <td colspan="4" class="font-blue font-size-18"><?= getPakistaniCurrency($amount) ?></td> -->
