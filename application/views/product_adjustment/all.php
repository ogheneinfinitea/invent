...
<html  lang="en">
    ...
    <head>
        ...
        <title> Facteezo: Products Adjustment </title>
                ...
                $('.dataTables_filter input').attr("placeholder", "Search...");
                            ...
                            <div id="page-title" style="overflow: hidden;">
                                <div class="col-md-6">
                                    ...
                                    <p>Add, Edit or Delete Product Adjustments</p>
                                </div>
                                <div class="col-md-6">
                                    <button class="btn btn-blue-alt pull-right" onclick="AddAdjustment();"><span style="margin-right: 5px;" class="glyph-icon icon-plus"></span>Add New Adjustment</button>
                                </div>
                            </div>
                                    ...
                                    <div class="example-box-wrapper">
                                        <table id="datatable-responsive" class="table table-striped table-bordered responsive no-wrap" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                               ...
                                               <?php foreach ($product_ledger as $product_ledger) 
                                               {
                                                    ?>
                                                    <tr>
                                                  
                                                        
                                                        <td><?= $product_ledger->product_ledger_id ?></td>
                                                        <td><?= $product_ledger->date_ledger ?></td>
                                                        <td><?= $product_ledger->product_name ?></td>
                                                        <td><?= $product_ledger->credit_qty ?></td>
                                                        <td><?= $product_ledger->debit_qty ?></td>

                                                        <td>
                                                        <?php if($this->session->userdata('user_group_id') == 1){ ?>    
                                                          <!--   <button class="btn btn-round btn-info" data-toggle="modal" data-target="#myModal" onclick="EditAdjustment('<?= $batch->batch_id ?>');">
                                                                <i class="glyph-icon icon-pencil"></i>
                                                            </button>
                                                            <button class="btn btn-round btn-danger" onclick="DeleteAdjustment('<?= $batch->batch_id ?>');">
                                                                <i class="glyph-icon icon-trash"></i>
                                                            </button> -->
                                                            <button class="btn btn-round btn-success"  data-toggle="tooltip" data-placement="top" title="View" data-toggle="modal" data-target="#myModal" onclick="ViewAdjustment('<?= $product_ledger->product_ledger_id ?>');">
...
//                                                                     window.location.href = "<?= base_url() ?>accounts_adjustment/view/" + batch_id;
...
//                                                                     if (cnfirm) {
//                                                                         $.post("<?= base_url() ?>accounts_adjustment/delete", {id: batch_id})
//                                                                                 .done(function (data) {
// //                                                                                    alert(data);
//                                                                                     if ($.trim(data) == 'done') {
...
//                                                                     }
//                                                                 }
                                                                function ViewAdjustment(invoice_id) {
                                                                        window.location.href = "<?= base_url() ?>product_adjustment/view_adjustment/" + invoice_id;
                                                                    }
                                                                function AddAdjustment() {
                                                                    window.location.href = "<?= base_url() ?>product_adjustment/add";
                                                                }
