...
<!--<link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/widgets/chosen/chosen.css">-->
            ...
            // });
                            ...
                            <div id="page-title">
                                <h2>Add a new Product Adjusment</h2>
                                <p>Select Product and Add Adjustment Quantity</p>
                                ...
                                <div class="panel-body">
                                 ...
                                 <div id='show_err' class="col-md-10 font-red" style="font-size:18px; font-weight: bold;">
                                    ...
                                    <div class="example-box-wrapper">
                                        <form method="post" action="<?= base_url() ?>product_adjustment/add" id="SubmitAdd" class="form-horizontal bordered-row" onsubmit="return ConfirmAdd();">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="input-prepend input-group">
                                                        ...
                                                        <input id="date_ledger" name="date_ledger" type="text" class="bootstrap-datepicker form-control"  value="<?php echo date("m-d-Y") ?>" data-date-format="mm/dd/yy">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">    
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <select onchange="add_units(this.options[this.selectedIndex].getAttribute('unit_symbol')),Validation()" name="product" id="product" class="chosen-select">
                                                        <option value="">Select Option</option>
                                                        <?php foreach ($products as $product) { ?>
                                                            <option unit_symbol="<?=$product->unit_symbol?>" value="<?= $product->product_id ?>"><?= $product->product_name ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label">Debit Quantity</label>
                                                <div class="col-sm-6">
                                                    <div class="input-group" id="div_qty1">
                                                        
                                                        <input type="number" name="debit_qty" onkeyup="Validation()" id="debit_qty" class="form-control" placeholder="Debit Quantity">
                                                        <span class="input-group-addon">Unit</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label">Credit Quantity</label>
                                                <div class="col-sm-6">
                                                    <div class="input-group" id="div_qty2">
                                                        
                                                        <input type="number" name="credit_qty" onkeyup="Validation()" id="credit_qty" class="form-control" placeholder="Credit Quantity">
                                                        <span class="input-group-addon">Unit</span>
                                                    </div>
                                                </div>
                                            </div>
