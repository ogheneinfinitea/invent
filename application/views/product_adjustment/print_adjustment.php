...
<html  lang="en">
    ...
    <head>
        ...
        <script>
            function print_me() {
                window.print();
                window.location.href = "<?= base_url() ?>product_adjustment/view_adjustment/<?= $product_ledger[0]->product_ledger_id ?>";
                    }
        </script>
    ...
    <body onload="print_me();">
        <table width="100%" >
            <tr>
                <td colspan="3" width="40%" style="height: 40px">
                    <div class="">
      ...
      <hr style="margin-top: 0px; margin-bottom: 0px;">
        <table width="100%" class="">
            <tr><th  style="width: 50%;" ><h2 class="invoice-client">Product information:</h2></th>
        ...
        <table class="table table-hover table-bordered" table-border="2px">
            <thead>
                <tr>
                    <th>#</th>
                    <th>Description</th>
            ...
            <tbody>
                <?php
                $count = 1;
                foreach ($product_ledger as $product_ledgers) {
                    ?>
                    <tr>
                        <td><?= $count ?></td>
                        <td><?= $product_ledger[0]->product_ledger_desc ?></td>
                        <td class="text-center"><?= ($product_ledger[0]->credit_qty!='0.00')?$product_ledger[0]->credit_qty: $product_ledger[0]->debit_qty ?></td>
                    </tr>
                    <?php
                    $count++;
                }
