...
<html  lang="en">
    ...
    <!-- Mirrored from agileui.com/demo/monarch/demo/admin-template/ordr.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 02 Mar 2017 12:12:30 GMT -->
    <head>
                ...
                <div id="page-content-wrapper">
                    <div id="page-content">
                        ...
                        <div class="container">
                            ...
                            <script>
                                function printordr() {
                                    window.location.href = "<?= base_url() ?>sale_order/print_inv/<?= $ordr[0]->ordr_id ?>";
//                                    window.print();
                                        }
                                        function printGatepass() {
                                            window.location.href = "<?= base_url() ?>sale_order/print_gatepass/<?= $ordr[0]->ordr_id ?>";
//                                    window.print();
                                                }
                                                function cancelordr() {
                                                    window.location.href = "<?= base_url() ?>sale_order";
//                                    window.print();
                                                }
                            </script>
                            <div class="content-box pad25A">
                                <div class="row">
                                    ...
                                    <div class="col-sm-8 float-right text-right">
                                        ...
                                        <button onclick="printordr()" class="btn btn-alt btn-hover btn-info">
                                            <span>Print Sale Order</span>
                                            <i class="glyph-icon icon-print"></i>
                                        </button>
                                        <button onclick="cancelordr()" class="btn btn-alt btn-hover btn-danger">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <h2 class="ordr-client mrg10T">Client information:</h2>
                                    ...
                                    <div class="col-md-4">
                                        <h2 class="ordr-client mrg10T">Order Info:</h2>
                                        <ul class="reset-ul">
                                            <li><b>Date:</b><?= date("F j, Y", strtotime($ordr[0]->date_created)) ?></li>
                                           <!--  <li><b>Status:</b> <?= $ordr[0]->payment_status == 'Pending' ? '<span class="bs-label label-warning">Pending</span>' : '<span class="bs-label label-success">Confirmed</span>' ?></li> -->
                                            <!-- <li><b>Id:</b> #<?= $ordr[0]->ordr_id ?></li> -->
                                        </ul>
                                    </div>
                                    <div class="col-md-4">
                                        <h2 class="ordr-client mrg10T">Order Description:</h2>
                                ...
                                <table class="table mrg20T table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($ordr_items as $ordr_item) {
                                            ...
                                            <tr>
                                                <td><?= $count ?></td>
                                                <td><?= $ordr_item->product_name ?></td>
                                                <td class="text-center"><?= $ordr_item->qty . " " . $ordr_item->unit ?></td>
                                                                                                <!-- <td class="text-center"><?= $ordr_item->product_sale_price ?> Rs</td>
                                  ...
                                  <!--   <tr class="font-bold font-black">
                                        ...
                                        <td colspan="3" class="font-red"><?= $ordr[0]->total_discount ?> Rs</td>
                                    </tr>
                                    <tr class="font-bold font-black">
                                        <td colspan="4" class="text-right">TOTAL:</td>
                                        <td colspan="3" class="font-blue font-size-23"><?= $ordr[0]->ordr_total ?> Rs</td>
                                    </tr> -->
                                    </tbody>
                                </table>
