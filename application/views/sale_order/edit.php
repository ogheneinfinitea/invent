...
<!--<link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/widgets/chosen/chosen.css">-->
            ...
            // });
                            ...
                            <div id="page-title">
                                ...
                                <p>Edit Required information for Sale Order</p>
                            ...
                            <div class="panel">
                                <div class="panel-body">
                                    ...
                                    <div class="example-box-wrapper">
                                        <form method="post" action="<?= base_url() ?>sale_order/edit" id="SubmitAdd" class="form-horizontal bordered-row">
...
//                                                        print_r($ordr_item->qty);
                                                        $html .= '<div class="col-sm-12 prod" id="prod' . $id . '"><div class="col-sm-5">';
...
//                echo $key . "<br>";
                                                        ...
                                                        $html .= '</select></div>';
                                                        $html .= '</div><div class="col-sm-3"><div id="div_qty' . $id . '" class="input-group"><input type="number" name="qty[]" step=".01" step=".01" value="' . $ordr_item->qty . '" id="qty' . $id . '" class="form-control" placeholder="Qty"><span class="input-group-addon bootstrap-touchspin-postfix">' . $unit . '</span></div></div>';
                                                        $html .= '<div class="col-sm-2" style="display:none;"><div id="div_sale_price' . $id . '" class="input-group"><input type="number" onblur="setTwoNumberDecimal(this.id)" onkeyup="CalculateSubTotal(' . $id . ');" step="0.01" name="sale_price[]" id="sale_price' . $id . '" value="' . $ordr_item->product_sale_price . '" class="form-control" placeholder="Sale Price"><span class="input-group-addon bootstrap-touchspin-postfix">Rs</span></div></div>';
                                                        ...
                                                        $html .= '<div class="col-sm-3" style="width:12%;"><div id="div_batch' . $id . '" class="input-group"><select onchange="GetBatchProCount(this.value,' . $id . ')" name="batch[]" id="batch' . $id . '" class="chosen-select">';
...
//                                                document.getElementsByClassName("discount").addEventListener('keyup', checkTabPress);
                                                ...
                                                function add_product() {
                                                    ...
                                                    html += '</div><div class="col-sm-3"><div id="div_qty' + id + '" class="input-group"><input type="number" name="qty[]" step=".01" step=".01" id="qty' + id + '" class="form-control" placeholder="Qty"></div></div>';
                                                    html += '<div class="col-sm-2" style="display:none;"><div id="div_sale_price' + id + '" class="input-group"><input type="number" onblur="setTwoNumberDecimal(this.id)" onkeyup="CalculateSubTotal(' + id + ');" step="0.01" name="sale_price[]" id="sale_price' + id + '" class="form-control" placeholder="Sale Price"></div></div>';
                                                    ...
                                                    html += '<div class="col-sm-3" style="width:12%;"><div id="div_batch' + id + '" class="input-group"><select onchange="GetBatchProCount(this.value,' + id + ')" name="batch[]" id="batch' + id + '" class="chosen-select">' + $("#batch_suggestions").val() + '</select></div></div>';
