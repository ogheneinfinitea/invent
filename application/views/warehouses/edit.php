...
<!--<link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/widgets/chosen/chosen.css">-->
                            ...
                            <div id="page-title">
                                ...
                                <p>Update Name or Symbol for Warehouse</p>
                            ...
                            <div class="panel">
                                <div class="panel-body">
                                    ...
                                    <div class="example-box-wrapper">
                                        <form method="post" action="<?= base_url() ?>warehouses/edit" id="SubmitEdit" class="form-horizontal bordered-row">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="name" id="name" value="<?= $warehouse[0]->warehouse_name ?>" class="form-control" placeholder="Section Name">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="address" id="address" value="<?= $warehouse[0]->warehouse_address ?>" class="form-control" placeholder="Address">
                                                    </div>
                                                </div>
                                            </div>
                                            <input type="hidden" name="warehouse_id" value="<?= $warehouse[0]->warehouse_id ?>" />
