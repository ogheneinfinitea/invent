            ...
            $(document).ready(function () {
                $('.dataTables_filter input').attr("placeholder", "Search...");
                            ...
                            <div id="page-title" style="overflow: hidden;">
                                ...
                                <div class="col-md-6">
                                    <button class="btn btn-blue-alt pull-right" onclick="AddUser();"><span style="margin-right: 5px;" class="glyph-icon icon-plus"></span>Add User</button>
                                </div>
                            </div>
    ...
    <th>Manage</th>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php if ($user->status == 1) { ?>
                                                                <span class="bs-label label-primary">Active</span>
                                                            <?php } else { ?>
                                                                <span class="bs-label label-danger">Inactive</span>
                                                            <?php } ?>
                                                        </td>
                                                        <td>
                                                        <?php if($this->session->userdata('user_group_id') == 1){ ?>
                                                            <button class="btn btn-round btn-info" data-toggle="tooltip" data-placement="top" title="Edit" data-toggle="modal" data-target="#myModal" onclick="EditUser('<?= $user->id ?>');">
                                                                <i class="glyph-icon icon-pencil"></i>
                                                            </button>
                                                            <button class="btn btn-round btn-danger" data-toggle="tooltip" data-placement="top" title="Delete" onclick="DeleteUser('<?= $user->id ?>');">
            ...
            <script>
                                                            function EditUser(user_id) {
                                                                window.location.href = "<?= base_url() ?>users/view/" + user_id;
                                                            ...
                                                            function DeleteUser(user_id) {
                                                                ...
                                                                if (cnfirm) {
                                                                    $.post("<?= base_url() ?>users/delete", {id: user_id})
                                                                            .done(function (data) {
//                                                                                    alert(data);
                                                                                if ($.trim(data) == 'done') {
