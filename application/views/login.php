...
<html lang="en">
        ...
        <script>
            function Login() {
                ...
                if (error == true) {
                    ...
                    //                                            alert("hello");
                    $.post("<?= base_url() ?>login/confirm", {email: email, password: password})
                            .done(function (data) {
                                if ($.trim(data) == 'done') {
            ...
            //                                     function failure() {
            //                                         $('#err').html('<button id="close" data-dismiss="alert" class="close" type="button" >×</button><ul style="background-color: pink;height: 67px;/* align-content: center; */margin-top: 38px;line-height: 73px;"><?php echo '<b style="font-size: initial;font-style: italic;font-weight: 100;" >Username/Password is incorrect</b>' ?></ul>');
            //                                     }
            //                                     $("#close").click(function () {
            //                                         $.post("<?= base_url() ?>login/failed")
            //                                                 .done(function (data) {
            //                                                     if ($.trim(data) == 'done') {
            //                                                         $('#err').hide();
            //                                                     }
    ...
    <body>
        ...
        <img src="<?= base_url() ?>assets/image-resources/blurred-bg/blurred-bg-3.jpg" class="login-img wow fadeIn" alt="">
                ...
                <div class="col-md-3 center-margin">
                    ...
                    <div class="content-box wow bounceInDown modal-content">
                        <h3 class="content-box-header content-box-header-alt bg-default">
                            ...
                            <span class="header-wrapper" style="margin-left: 105px;">
                                <img src="<?= base_url() ?>image-resources/facteezo2.png" />
                        ...
                        <div class="content-box-wrapper">
                            ...
                            <button class="btn btn-success btn-block" onclick="return Login();">Sign In</button>
