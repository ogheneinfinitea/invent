...
<html  lang="en">
    ...
    <head>
        ...
        <style>
            ...
            .img-upload-btn { position: relative; overflow: hidden; padding-top: 95%;}
            .img-upload-btn input[type=file] { position: absolute; top: 0; right: 0; min-width: 100%; min-height: 100%;font-size :100px; text-align: right; filter: alpha(opacity=0); opacity: 0; outline: none; background: white; cursor:inherit; display: block; }
            .img-upload-btn i {position: absolute;height: 16px;width: 16px;top: 50%;left: 50%;margin-top: -8px;margin-left: -8px;} .btn-radio {position: relative; overflow: hidden; } .btn-radio input[type=radio] { position: absolute; top: 0; right: 0; min-width: 100%; min-height: 100%; font-size: 100px; text-align: right; filter: alpha(opacity=0); opacity: 0; outline: none; background: white; cursor: inherit; display: block; }
        </style>


        <meta charset="UTF-8">
        <!--[if IE]><meta http-equiv='X-UA-Compatible' content='IE=edge,chrome=1'><![endif]-->
        <title> Facteezo: General Setting </title>
                            ...
                            <div class="panel">
                                <div class="panel-body">
                                    ...
                                    <div class="example-box-wrapper">
                                        <form method="post" action="<?= base_url() ?>general_setting/" id="SubmitAdd" class="form-horizontal bordered-row" enctype="multipart/form-data">

                                            <div class="form-group">
                                                <label class="col-sm-3 control-label">Company Logo: </br><span>( Size: 126X34 )</span></label>
                                                <div class="col-sm-6">
                                                    <!-- <div class="img-picker" ></div> -->
                                                    <input class="col-md-6" type="file"  name="company_logo" id="company_logo" onchange="ohcomeon(this, this.id);" />
                                                    <?php if ($general_setting[0]->company_logo != null) { ?>
                                                        <img class="col-md-6 pull-right" src="<?php echo base_url() . 'images/' . $general_setting[0]->company_logo ?>" style="width:80px; height: 50px;margin-top: -14px;" id="company_logoo"/>
                                                    <?php } ?>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label">Company View Logo: </br><span>( Size: 226X100 )</span></label>
                                                <div class="col-sm-6">
                                                    <!-- <div class="img-picker" ></div> -->
                                                    <input class="col-md-6" type="file"  name="company_view_logo" id="company_view_logo" onchange="ohcomeon(this, this.id);" />
                                                    <?php if ($general_setting[0]->company_view_logo != null) { ?>
                                                        <img class="col-md-6 pull-right" src="<?php echo base_url() . 'images/' . $general_setting[0]->company_view_logo ?>" style="width:80px; height: 50px;margin-top: -14px;" id="company_view_logoo"/>
                                                    <?php } ?>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label">Company Print/Invoice/Reports Logo: </br><span>( Size: 1154X166 )</span></label>
                                                <div class="col-sm-6">
                                                    <!-- <div class="img-picker" ></div> -->
                                                    <input class="col-md-6" type="file"  name="company_invoice_logo" id="company_invoice_logo" onchange="ohcomeon(this, this.id);" />
                                                    <?php if ($general_setting[0]->company_invoice_logo != null) { ?>
                                                        <img class="col-md-6 pull-right" src="<?php echo base_url() . 'images/' . $general_setting[0]->company_invoice_logo ?>" style="width:80px; height: 50px;margin-top: -14px;" id="company_invoice_logoo"/>
                                                    <?php } ?>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="text" name="company_name"  id="company_name" value="<?= $general_setting[0]->company_name ?>" class="form-control" >
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label">Company Address</label>
                                                <div class="col-sm-6">
                                                    <input type="text" name="company_address"  id="company_address" value="<?= $general_setting[0]->company_address ?>" class="form-control" >
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="text" name="currency"  id="currency" value="<?= $general_setting[0]->currency_symbol ?>" class="form-control">
                                                </div>
                                            </div>
            ...
            <script>
                function ConfirmAdd() {
                    ...
                    if (company_name == "" || company_name == null) {
                        $("#company_logo_chosen").css("border", "1px solid red");
                        err = true;
                    }
                ...
                function Validation() {
                    ...
                    if (from_account !== "" & from_account !== null) {
                        $("#from_account_chosen").css("border", "1px solid #dfe8f1");
                        err = true;
                    }
                    if (to_account !== "" & to_account !== null) {
                        $("#to_account_chosen").css("border", "1px solid #dfe8f1");
                        err = true;
                    }
                    if (amount !== "" & amount !== null) {
                        $("#amount").css("border", "1px solid #dfe8f1");
                        err = true;
                    }
                    // if (err === true) {
                    //     return false;
...
//
                            ...
                            $('#company_logoo').css('display', '');
                            reader.readAsDataURL(input.files[0]);
                        }
                        if (id == 'company_view_logo') {
//
                            var reader = new FileReader();
                            reader.onload = function (e) {
                                $('#company_view_logoo')
                            ...
                            $('#company_view_logoo').css('display', '');
                            reader.readAsDataURL(input.files[0]);
                        }
                        if (id == 'company_invoice_logo') {
//
                            var reader = new FileReader();
                            reader.onload = function (e) {
                                $('#company_invoice_logoo')
                                        .attr('src', e.target.result)
                                        .width(50)
                                        .height(50);
                            };

                            $('#company_invoice_logoo').css('display', '');
                            reader.readAsDataURL(input.files[0]);
                        }
