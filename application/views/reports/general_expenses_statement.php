...
<html  lang="en">
    <head>
        ...
        <title> Facteezo:General Expenses Statement </title>
        ...
        <script>
            ...
            function printReport(divName) {
                var printContents = '<table class="my_print" width="100%"  border="1" cellpadding="10" cellspacing="10">'+document.getElementById(divName).innerHTML+'</table>';
                ...
                // $(".my_print td").css("padding-left","5px;");
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <form name="AccountForm" method="post" id="AccountForm" action="<?= base_url() ?>reports/general_expenses_statement" class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5" id="account_div">
                                        <select name="account" id="account" class="chosen-select">
                                            <option id="option_after" value="">ALL GENERAL ACCOUNTS</option>
    ...
    <!--<link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/widgets/datatable/datatable.css">-->
                            ...
                            <div id="page-title" style="overflow: hidden;">
                                <h2>General Expenses Statement Report<!-- <?= !empty($account_name) ? " for <i>" . $account_name . "</i>" : "" ?> --></h2>
...
//
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="font-size: 18px; font-style: italic"><b><?= $total_amount ?> Rs</b></td>
                                                </tr>
