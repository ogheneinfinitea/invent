...
<head>
    <style>
        ...
        <title> Facteezo: Account Statement </title>
        ...
        <script>
            ...
            function printAccountLedger(divName) {
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <form name="AccountForm" method="post" id="AccountForm" action="<?= base_url() ?>reports/account_statement" class="form-horizontal">
    ...
    <!--<link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/widgets/datatable/datatable.css">-->
                            ...
                            <div id="page-title" style="overflow: hidden;">
                                <h2>Account Statement Report<?= !empty($account_name) ? " for <i>" . $account_name . "</i>" : "" ?></h2>
                                <p>Detailed report<?= isset($from_date) ? " from <b>" . date("j F, Y", strtotime($from_date)) . "</b> To <b>" . date("j F, Y", strtotime($to_date)) . "</b>" : "" ?></p>
                             
                                <button class="btn btn-primary btn-print" onclick="printAccountLedger('PrintArea');">Print Detail Summary</button>
                                <button class="btn btn-primary btn-print" onclick="printAccountLedgerProduct();"> Print Without Products </button>
                                        ...
                                        <table  class="table" id='PrintArea'>
                                            ...
                                            <tbody>
                                                ...
                                                if (isset($from_date)) {
                                                    ...
                                                    echo "<td>" . date("d/m/Y", strtotime(time())) . "</td>";
                                                }
                                                echo "<td>Opening Balance</td>";
                                                echo "<td></td>";
                                                echo "<td></td>";
                                                echo "<td>" . $open_balance . "</td>";
                                                echo "</tr>";
                                                if (!empty($account_report)) {
//                                                    if (($account_report[0]->acc_open_date > $from_date) && ($account_report[0]->acc_open_date < $to_date)) {
//                                                    } else {
//                                                        $balance = 0;
//                                                    }
                                                    $ledger_count = 0;
                                                    foreach ($account_report as $value) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?= ($value->type=="adjustment"?"Adjustment<br>":"").html_entity_decode($description[0]) ?>
                                                                <span class="my_hidden">
                                                                <?php
                                                                $det = "";
                                                                foreach ($pro_report[$ledger_count] as $p_l) {
                                                                    if (empty($p_l)) {
                                                                        continue;
                                                                    }
                                                                    $det .= "(product:" . $p_l->product_name . ",qty:";
                                                                    $det .= !empty($p_l->credit_qty) ? $p_l->credit_qty : '';
                                                                    $det .= !empty($p_l->debit_qty) ? $p_l->debit_qty : '';
                                                                    $det .= " ";
                                                                    $det .= !empty($p_l->unit_symbol) ? $p_l->unit_symbol : '';
                                                                    $det .= "),";
                                                                }
                                                                $det = rtrim($det, ",");
                                                                echo $det;
                                                ...
                                                ?>
                                                <tr>
                                                    <td colspan="2" style="font-size: 18px; font-style: italic"><b>Total Calculated</b></td>
