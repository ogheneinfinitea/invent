...
<html  lang="en">
    ...
    <head>
        ...
        <!--[if IE]><meta http-equiv='X-UA-Compatible' content='IE=edge,chrome=1'><![endif]-->
            <title> Facteezo: Section Statement </title>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Select Section and Dates</h4>
                    </div>
                    <div class="modal-body">
                        <div class="row">
                            <form name="SectionForm" method="post" id="SectionForm" action="<?= base_url() ?>reports/section_statement" class="form-horizontal">
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">Select Section</label>
                                    <div class="col-sm-5" id="section_div">
                    ...
                    <div class="modal-footer">
                        ...
                        <button onclick="SubmitSectionForm();" type="button" class="btn btn-primary">Show Report</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!--<link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/widgets/datatable/datatable.css">-->
                            ...
                            <div id="page-title" style="overflow: hidden;">
                                <h2>SECTION Statement<?= !empty($secn) ? " for <i>" . $secn . "</i>" : "" ?></h2>
                                            ...
                                            <tbody>
                                                ...
                                                if (!empty($prev_balnc)) {
                                                    foreach ($prev_balnc as $balnc) {
                                                        ...
                                                        echo "<tr>";
                                                        if (isset($from_date)) {
                                                            echo "<th>" . date("d/m/Y", strtotime($from_date)) . "</th>";
                                                        } else {
                                                            echo "<th>" . date("d/m/Y", strtotime(time())) . "</th>";
                                                        }
                                                        echo "<th>" . $balnc->product_name . "</th>";
                                                        echo "<th>Opening Balance</th>";
                                                        echo "<th></th>";
                                                        echo "<th></th>";
                                                        echo "<th><b>" . $balnc->product_balnc . " " . $balnc->unit_symbol . "<span class='pull-right' "
                                                        . "onclick='OpenBox(" . $my_counter . ")' style='font-size:25px; font-weight:bold;color:blue; cursor:pointer;'>+</span></b></th>";
                                                        echo "</tr>";

                                                        //product
                                                        if (!empty($products_report)) {
                                                            echo "<tbody style='display:none;' id='tbody-" . $my_counter . "'>";
...
//                                                    }
                                                            ...
                                                            <tr>
                                                                <th colspan="2"><b><?= $balnc->product_name ?></b></th>
                                                                <th colspan="3"><b>CURRENT IN STOCK</b></th>
                                                                <th><b><?= $current_instock . " " . $balnc->unit_symbol ?></b></th>
                                                            </tr>
                                                            <?php
                                                            echo "</tbody>";
                                                            $my_counter++;
