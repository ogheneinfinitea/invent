...
<html  lang="en">
    ...
    <head>
        ...
        <script>
            ...
            function printFinalLedger(divName) {
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <form name="ProductForm" method="post" id="ProductForm" action="<?= base_url() ?>reports/final_statement" class="form-horizontal">
    ...
    <!--<link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/widgets/datatable/datatable.css">-->
                            ...
                            <div id="page-title" style="overflow: hidden;">
                                <h2>Production & Sale Report</h2>
                                <p>Detailed report<?= isset($from_date) ? " from <b>" . date("j F, Y", strtotime($from_date)) . "</b> To <b>" . date("j F, Y", strtotime($to_date)) . "</b>" : "" ?></p>
                               
                                <button class="btn btn-primary btn-print" onclick="printFinalLedger('PrintArea');">Print</button>
                            </div>
