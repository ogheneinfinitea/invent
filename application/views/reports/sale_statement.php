...
//                    $("#product_chosen").css("border", "1px solid red");
            ...
            function printSaleLedger(divName) {
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <form name="ProductForm" method="post" id="ProductForm" action="<?= base_url() ?>reports/sale_statement" class="form-horizontal">
    ...
    <!--<link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/widgets/datatable/datatable.css">-->
                            ...
                            <div id="page-title" style="overflow: hidden;">
                                <h2>Sale Statement Report<?= !empty($account_name) ? " for <i>" . $account_name . "</i>" : "" ?></h2>
                                <p>Detailed report<?= isset($from_date) ? " from <b>" . date("j F, Y", strtotime($from_date)) . "</b> To <b>" . date("j F, Y", strtotime($to_date)) . "</b>" : "" ?></p>
                            
                                <button class="btn btn-primary btn-print" onclick="printSaleLedger('PrintArea');">Print</button>
                            </div>
