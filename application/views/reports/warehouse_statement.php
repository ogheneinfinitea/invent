            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <form name="WarehouseForm" method="post" id="WarehouseForm" action="<?= base_url() ?>reports/warehouse_statement" class="form-horizontal">
...
//                                                        print_r($balance);
                                                        echo "<tr>";
                                                        if (isset($from_date)) {
                                                            echo "<th><b>" . date("d/m/Y", strtotime($from_date)) . "</b></th>";
                                                        } else {
                                                            echo "<th><b>" . date("d/m/Y", strtotime(time())) . "</b></th>";
                                                        }
                                                        echo "<th><b>" . $balnc["product_name"] . "</b></th>";
                                                        echo "<th><b>Opening Balance</b></th>";
                                                        echo "<th></th>";
                                                        echo "<th></th>";
