...
<html  lang="en">
    ...
    <head>
        ...
        <title> Facteezo: Final Goods General Statement </title>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <form name="WarehouseForm" method="post" id="WarehouseForm" action="<?= base_url() ?>reports/finalgood_general_statement" class="form-horizontal">
