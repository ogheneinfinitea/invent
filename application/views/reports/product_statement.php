...
<style>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <form name="ProductForm" method="post" id="ProductForm" action="<?= base_url() ?>reports/product_statement" class="form-horizontal">
    ...
    <!--<link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/widgets/datatable/datatable.css">-->
                            ...
                            <div id="page-title" style="overflow: hidden;">
                                <h2>Raw Products & Issue Report<?= !empty($account_name) ? " for <i>" . $account_name . "</i>" : "" ?></h2>
