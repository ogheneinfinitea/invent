...
<html  lang="en">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <form name="AccountForm" method="post" id="AccountForm" action="<?= base_url() ?>reports/bank_statement" class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5" id="account_div">
                                        <select name="account" id="account" class="chosen-select">
                                            <option id="option_after" value="">ALL BANK ACCOUNTS</option>
    ...
    <!--<link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/widgets/datatable/datatable.css">-->
                            ...
                            <div id="page-title" style="overflow: hidden;">
                                <h2>Bank Statement Report<!-- <?= !empty($account_name) ? " for <i>" . $account_name . "</i>" : "" ?> --></h2>
