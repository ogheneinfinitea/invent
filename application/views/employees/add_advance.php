...
<html  lang="en">
    ...
    <head>
        ...
        <title> Facteezo: Add Advance</title>
...
<!--<link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/widgets/chosen/chosen.css">-->
                            ...
                            <div id="page-title">
                                ...
                                <h2>Add Information for Employee Advance </h2>
                            ...
                            <div class="panel">
                                <div class="panel-body">
                                    ...
                                    <div class="example-box-wrapper">
                                        <form method="post" action="<?= base_url() ?>employees/add_advance" id="SubmitAdd" class="form-horizontal bordered-row">
                                            ...
                                            <div class="tab-pane pad0A fade active in" id="tab-example-4">
                                                <div class="">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label">Advance Month</label>
                                                        <div class="col-sm-6">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label">Advance Year</label>
                                                        <div class="col-sm-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <input type="text" name="emp_unique_id" id="emp_unique_id" class="form-control"  placeholder="" readonly="">
                                                        </div>
                                                    </div>

                                                    <div class="form-group">
                                                        <div class="col-sm-1"></div>
                                                        <label class="col-sm-2 control-label">Previous Advance</label>
                                                        <div class="col-sm-2">
                                                            <div class="input-group">
                                                                <span class="input-group-addon glyph-icon"><?= $this->session->userdata('currency_symbol') ?></span>
                                                                <input type="number" name="ledger_amount_prev" onkeyup="RevertValidation()" id="ledger_amount_prev" class="form-control" placeholder="Previous Advance">
                                                            </div>
                                                        </div>
                                                        <label class="col-sm-1 control-label">New Advance</label>
                                                        <div class="col-sm-2">
                                                            <div class="input-group">
                                                                <span class="input-group-addon glyph-icon"><?= $this->session->userdata('currency_symbol') ?></span>
                                                                <input type="number" name="ledger_amount" onkeyup="RevertValidation()" id="ledger_amount" class="form-control" placeholder="New Amount">
                                                            </div>
                                                        </div>
                                                        <label class="col-sm-1 control-label">Total Advance</label>
                                                        <div class="col-sm-2">
                                                            <div class="input-group">
                                                                <span class="input-group-addon glyph-icon"><?= $this->session->userdata('currency_symbol') ?></span>
                                                                <input type="number" name="ledger_amount_total" onkeyup="RevertValidation()" id="ledger_amount_total" class="form-control" placeholder="Total Advance">
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-sm-12">Description / Advance Notes</label>
                                                        <div class="col-sm-12">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <button class="btn btn-alt btn-hover btn-blue-alt col-md-4" onclick="return ConfirmAdd();">
                                                            <span>CONFIRM ADD Employee Advance</span>
                                                            <i class="glyph-icon icon-arrow-right"></i>
                                                        </button>
                                                        <div class="col-md-4 col-sm-0"></div>
                                                    </div>
                    ...
                    <script>
                        function ConfirmAdd() {
                            ...
                            if (ledger_amount == "" || ledger_amount == null) {
                                $("#ledger_amount").css("border", "1px solid red");
                                err = true;
                            }
