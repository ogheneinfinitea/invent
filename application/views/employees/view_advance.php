...
<html  lang="en">
    ...
    <head>
        ...
        <title> Facteezo: View Advance</title>
...
<!--<link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/widgets/chosen/chosen.css">-->
 ...
 <button class="btn btn-primary" onclick="PrintMe();">Print</button>
                            ...
                            <div id="page-title">
                                <h2 class="text-center font-bold">Information for Employee Advance </h2>
                            </div>
                            <!-- ////////////////Panel Start///////////////////////////// -->
                            <div class="panel">
                                    ...
                                    <div class="example-box-wrapper">
                                        ...
                                        <div class="tab-pane pad0A fade active in" id="tab-example-4">
                                            <div class="" id="PrintDiv">
                                                ...
                                                <table width="100%">
                                                    <tr>
                                                        <td><h4 class="text-center font-bold">Employee Details</h4></td>
                                                    </tr>
                                                </table >
                                                <table width="100%"><tr>
                                                        <td><label  control-label>Advance Date</label></td>
                                                        <td align="right"><?php echo date("m-d-Y", strtotime($employee_ledger[0]->ledger_date)) ?></td>
                                                    <tr>
                                                </table>
                                                <table width="100%">
                                                    <tr>
                                                        <td><label class="control-label">Advance Month</label></td>
                                                        <td align="right" id="month"><?= $employee_ledger[0]->month == '01' ? '01' : '' ?>
                                                            <?= $employee_ledger[0]->month == '02' ? '02' : '' ?>
                                                            <?= $employee_ledger[0]->month == '03' ? '03' : '' ?>
                                                            <?= $employee_ledger[0]->month == '04' ? '04' : '' ?>
                                                            <?= $employee_ledger[0]->month == '05' ? '05' : '' ?>
                                                            <?= $employee_ledger[0]->month == '06' ? '06' : '' ?>
                                                            <?= $employee_ledger[0]->month == '07' ? '07' : '' ?>
                                                            <?= $employee_ledger[0]->month == '08' ? '08' : '' ?>
                                                            <?= $employee_ledger[0]->month == '09' ? '09' : '' ?>
                                                            <?= $employee_ledger[0]->month == '10' ? '10' : '' ?>
                                                            <?= $employee_ledger[0]->month == '11' ? '11' : '' ?>
                                                            <?= $employee_ledger[0]->month == '12' ? '12' : '' ?></td>
                                                    </tr>
                                                </table>
                                                <table width="100%">
                                                    <tr>
                                                        <td><label class="control-label">Advance Year</label></td>
                                                ...
                                                <h3 class="text-center font-bold">Advance Details</h3>
                                                <table class="table table-bordered ">
                                                    <tr>
                                                        <th class="text-center"><b>Advance</b></th>
                                                        <th class="text-center"><b><?= $employee_ledger[0]->ledger_amount ?></b></th>
                                                    </tr>
                                                </table>
                                                </br>
                                                <table width="100%">
                                                <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="right">Employee Signature
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
