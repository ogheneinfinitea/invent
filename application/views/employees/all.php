...
<html  lang="en">
    ...
    <head>
        ...
        <title> Facteezo: All Employees </title>
...
//                $('.dataTables_filter input').attr("placeholder", "Search...");
                            ...
                            <div id="page-title" style="overflow: hidden;">
                                ...
                                <div class="col-md-6">
                                    <button class="btn btn-blue-alt pull-right" onclick="AddAcount();"><span style="margin-right: 5px;" class="glyph-icon icon-plus"></span>Add Employee</button>
                                </div>
                            </div>
                            ...
                            <div class="panel">
                                <div class="panel-body">
                                    <div class="row ">
                                        <a href="<?= base_url() ?>Employees"><h3 class="title-hero col-md-9">
                                                All Employees
                                            </h3></a>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?php if ($this->session->userdata('user_group_id') == 1) { ?>
                                                                    ...
                                                                    <button class="btn btn-round btn-info" data-toggle="tooltip" data-placement="top" title="Edit" data-toggle="modal" data-target="#myModal" onclick="EditAccount('<?= $employee['employee_id'] ?>');">
                                                                        <i class="glyph-icon icon-pencil"></i>
                                                                    </button>
                                                                    <button class="btn btn-round btn-danger" data-toggle="tooltip" data-placement="top" title="Delete" onclick="DeleteAccount('<?= $employee['employee_id'] ?>');">
            ...
            <script>
                                                                        ...
                                                                        function EditAccount(account_id) {
                                                                            window.location.href = "<?= base_url() ?>employees/view/" + account_id;
                                                                        }
                                                                        function DeleteAccount(account_id) {
                                                                            var cnfirm = confirm("Are You Sure?");
                                                                            if (cnfirm) {
                                                                                $.post("<?= base_url() ?>employees/delete", {id: account_id})
                                                                                        .done(function (data) {
                                                                                            if ($.trim(data) == 'done') {
                                                                        ...
                                                                        function AddAcount() {
                                                                            window.location.href = "<?= base_url() ?>employees/add";
                                                                        }
                ...
                $("#search").keyup(function (event) {
                    ...
                    if (keycode == '13') {
                        ...
                        if (rtngPtId == "") {
                            ...
                            $.post("<?= base_url() ?>Employees/search", {id: rtngPtId})
                                    .done(function (data) {
