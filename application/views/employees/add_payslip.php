...
<html  lang="en">
    ...
    <head>
        ...
        <title> Facteezo: Add Payslip</title>
...
<!--<link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/widgets/chosen/chosen.css">-->
                            ...
                            <div class="panel">
                                <div class="panel-body">
                                    ...
                                    <div style="font-weight: bold;font-size: 14px;color: red;"><?= $this->session->flashdata("already") ?></div>
                                    <div class="example-box-wrapper">
                                        <form method="post" action="<?= base_url() ?>employees/add_payslip" id="SubmitAdd" class="form-horizontal bordered-row">
                                                ...
                                                <div class="">
                                                    <form class="form-horizontal pad15L pad15R bordered-row">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <input id="ledger_date" name="ledger_date" type="text" class="bootstrap-datepicker form-control" value="<?php echo date("m-d-Y") ?>" data-date-format="mm/dd/yy">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
