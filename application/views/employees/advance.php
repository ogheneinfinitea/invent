...
<html  lang="en">
    ...
    <head>
        ...
        <title> Facteezo: All Advances </title>
...
//                $('.dataTables_filter input').attr("placeholder", "Search...");
                            ...
                            <div id="page-title" style="overflow: hidden;">
                                <div class="col-md-6">
                                    <h2>Advances</h2>
                                    <p>Add, Edit or Delete Advances</p>
                                </div>
                                <div class="col-md-6">
                                    <button class="btn btn-blue-alt pull-right" onclick="AddAcount();"><span style="margin-right: 5px;" class="glyph-icon icon-plus"></span>Add Advance</button>
                                </div>
                            </div>
                            ...
                            <div class="panel">
                                <div class="panel-body">
                                    <div class="row ">
                                        <a href="<?= base_url() ?>Advances/advance"><h3 class="title-hero col-md-9">
                                                All Advances
                                            </h3></a>
                                                ...
                                                if (!empty($advances)): $count = 1;
                                                    ...
                                                    foreach ($advances as $advance) :
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?= $advance->ledger_amount ?></td>
                                                            <td>
                                                                <button class="btn btn-round btn-success" data-toggle="tooltip" data-placement="top" title="View" onclick="ViewAdvance('<?= $advance->employee_ledger_id ?>');">
            ...
            <script>
                                    function ViewAdvance(account_id) {
                                            window.location.href = "<?= base_url() ?>employees/view_advance_print/" + account_id;
                                                                        }
                                        ...
                                        function AddAcount() {
                                            window.location.href = "<?= base_url() ?>employees/add_advance";
                                        }
