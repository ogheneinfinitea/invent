...
<html  lang="en">
    ...
    <head>
        ...
        <title> Facteezo: All Increments </title>
...
//                $('.dataTables_filter input').attr("placeholder", "Search...");
                            ...
                            <div id="page-title" style="overflow: hidden;">
                                <div class="col-md-6">
                                    <h2>Increments</h2>
                                    <p>Add, Edit or Delete Increments</p>
                                </div>
                                <div class="col-md-6">
                                    <button class="btn btn-blue-alt pull-right" onclick="AddAcount();"><span style="margin-right: 5px;" class="glyph-icon icon-plus"></span>Add Increment</button>
                                </div>
                            </div>
                            ...
                            <div class="panel">
                                <div class="panel-body">
                                    <div class="row ">
                                        <a href="<?= base_url() ?>Increments/increment"><h3 class="title-hero col-md-9">
                                                All Increments
                                            </h3></a>
                                    ...
                                    <div class="example-box-wrapper">
                                        <table  class="table table-striped table-bordered responsive no-wrap" cellspacing="0" width="100%">
                                            <tbody class="post-list" id="postList">
                                                ...
                                                <?php
                                                if (!empty($increments)): $count = 1;

                                                    foreach ($increments as $increment) :
                                                        ?>
                                                        <tr>
                                                            <td ><?php echo $count; ?></td>
                                                            <td><?= $increment->employee_salary_id ?></td>
                                                            <td><?= $increment->emp_name ?></td>
            ...
            <script>
                                        ...
                                        function AddAcount() {
                                            window.location.href = "<?= base_url() ?>employees/add_increment";
                                        }
                ...
                $("#search").keyup(function (event) {
                    ...
                    if (keycode == '13') {
                        ...
                        if (rtngPtId == "") {
                            ...
                            $.post("<?= base_url() ?>Increments/search", {id: rtngPtId})
                                    .done(function (data) {
