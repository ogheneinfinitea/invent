...
<html  lang="en">
    ...
    <head>
        ...
        <title> Facteezo: Add Increment</title>
...
<!--<link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/widgets/chosen/chosen.css">-->
                            ...
                            <div id="page-title">
                                ...
                                <h2>Add Information for Employee Increment </h2>
                            ...
                            <div class="panel">
                                <div class="panel-body">
                                    ...
                                    <div class="example-box-wrapper">
                                        <form method="post" action="<?= base_url() ?>employees/add_increment" id="SubmitAdd" class="form-horizontal bordered-row">
                                            ...
                                            <div class="tab-pane pad0A fade active in" id="tab-example-4">
                                                <div class="">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <select name="emp_name"  id="emp_name" class="chosen-select" onchange="GetEmployeeUniqueID(this.options[this.selectedIndex].getAttribute('emp_unique_id'));GetBasicSalary(this.value);">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label">Employee Basic Salary</label>
                                                        <div class="col-sm-6">
                                                            <input type="text" name="emp_basic_salary" id="emp_basic_salary" class="form-control"  placeholder="" readonly="">
                                                        </div>
                                                    </div>

                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label">Employee New Salary</label>
                                                        <div class="col-sm-6">
                                                            <div class="input-group">
                                                                <span class="input-group-addon glyph-icon"><?= $this->session->userdata('currency_symbol') ?></span>
                                                                <input type="number" name="ledger_amount" onkeyup="RevertValidation()" id="ledger_amount" class="form-control" placeholder="Employee New Salary">
                                                            </div>
                                                        </div>
                                                    </div>

                                                    <div class="form-group">
                                                        <label class="col-sm-12">Description / Increment Notes</label>
                                                        <div class="col-sm-12">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <button class="btn btn-alt btn-hover btn-blue-alt col-md-4" onclick="return ConfirmAdd();">
                                                            <span>CONFIRM ADD Employee Increment</span>
                                                            <i class="glyph-icon icon-arrow-right"></i>
                                                        </button>
                                                        <div class="col-md-4 col-sm-0"></div>
                                                    </div>
