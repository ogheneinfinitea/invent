...
<!--<link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/widgets/chosen/chosen.css">-->
            ...
            // });
                            ...
                            <div id="page-title">
                                <h2>Add a new Account Adjusment</h2>
                                <p>Select Account and Add Adjustment Ammount</p>
                                ...
                                <div class="panel-body">
                                 ...
                                 <div id='show_err' class="col-md-10 font-red" style="font-size:18px; font-weight: bold;">
                                    ...
                                    <div class="example-box-wrapper">
                                        <form method="post" action="<?= base_url() ?>accounts_adjustment/add" id="SubmitAdd" class="form-horizontal bordered-row" onsubmit="return ConfirmAdd();">
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label">Debit Amount</label>
                                                <div class="col-sm-6">
                                                    <div class="input-group" id="div_qty">
                                                        
                                                        <input type="number" name="debit_amount" onkeyup="Validation()" id="debit_amount" class="form-control" placeholder="Debit Amount">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="input-group" id="div_qty">
                                                        ...
                                                        <input type="number" name="credit_amount" onkeyup="Validation()" id="credit_amount" class="form-control" placeholder="Credit Amount">
                                                        <span class="input-group-addon">Rs</span>
                                                    </div>
                                                </div>
                                            </div>
            ...
            <script>
                ...
                if ((debit_amount != null || debit_amount != 0) && (credit_amount != null || credit_amount != 0)) {
                 $("#show_err").html("<b>You Cannot Enter Both Debit And Credit Amount!<b>");
                  $("#debit_amount").css("border", "1px solid red");
                   $("#credit_amount").css("border", "1px solid red");
                    err = true;
                }

                    if (debit_amount == null || debit_amount == 0) {
                        if(credit_amount==null || credit_amount==0){
                            $("#show_err").html("<b>Please enter at leaset Debit Amount OR Credit Amount<b>");
                            err = true;
                        }
                        else{
                            err=false;
 ...
 function Validation() {
                    ...
                    if ((debit_amount !== null & debit_amount !== 0)&&(credit_amount !== null & credit_amount !== 0)) {
                     $("#show_err").html("");
                      $("#debit_amount").css("border", "1px solid #dfe8f1");
                       $("#credit_amount").css("border", "1px solid #dfe8f1");
                        err = true;
                    }
