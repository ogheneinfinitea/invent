                        ...
                        <div class="container">
                            ...
                            <script>
                                function printadjustment() {
                                    window.location.href = "<?= base_url() ?>accounts_adjustment/print_adjustment/<?= $ledger[0]->ledger_id ?>";
                                   // window.print();
                                        }

                                                function canceladjustment() {
                                                    window.location.href = "<?= base_url() ?>accounts_adjustment";
                            ...
                            <div class="content-box pad25A">
                                <div class="row">
                                    ...
                                    <div class="col-sm-8 float-right text-right">
                                        ...
                                        <div class="invoice-date mrg20B"><?= date("j F Y", strtotime($ledger[0]->ledger_date)) ?></div>
                                ...
                                <table class="table mrg20T table-hover" style="width: 100%;">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($ledger as $ledger) {
                                            ...
                                            <tr>
                                                <td><?= $counter ?></td>
                                                <td><?= $ledger->ledger_desc ?></td>
                                                <td class="text-center"><?= ($ledger->credit_amount!='0.00')?$ledger->credit_amount: $ledger->debit_amount ?>Rs</td>
                                            </tr>
                                            <?php
                                            $counter++;
                                        }
