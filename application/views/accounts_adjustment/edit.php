...
<!--<link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/widgets/chosen/chosen.css">-->
                            ...
                            <div id="page-title">
                                <h2>Edit Account Adjustment</h2>
                                <p>Edit Account and Adjustment</p>
                            ...
                            <div class="panel">
                                <div class="panel-body">
                                    ...
                                    <div class="example-box-wrapper">
                                        <form method="post" action="<?= base_url() ?>accounts_adjustment/edit/<?= $batch[0]->batch_id ?>" id="SubmitAdd" class="form-horizontal bordered-row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="input-prepend input-group">
                                                        ...
                                                        <input id="date" name="date" type="text" class="bootstrap-datepicker form-control"  value="<?php echo date("m-d-Y") ?>"<?= $batch[0]->batch_no ?>" data-date-format="mm/dd/yy">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label">Adjustment Amount</label>
                                                <div class="col-sm-6">
                                                    <div class="input-group" id="div_qty">
                                                        
                                                        <input type="number" name="amount" id="amount" class="form-control" value="" placeholder="Adjustment Amount">
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label">Adjustment No. </label>
                                                <div class="col-sm-6">
                                                    <div class="input-group">
                                                        
                                                        <input type="number" name="adj_no" id="adj_no" class="form-control" placeholder="Adjustment No.">
