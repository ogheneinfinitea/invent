...
<!--<link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/widgets/chosen/chosen.css">-->
                            ...
                            <div id="page-title">
                                ...
                                <p>Update Name for  Account Type </p>
                            ...
                            <div class="panel">
                                <div class="panel-body">
                                    ...
                                    <div class="example-box-wrapper">
                                        <form method="post" action="<?= base_url() ?>account_type/edit" id="SubmitEdit" class="form-horizontal bordered-row">
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label">Account Type</label>
                                                <div class="col-sm-6">
                                                    <div class="input-group">
                                                        <span class="input-group-addon glyph-icon icon-circle-o"></span>
                                                        <input type="text" name="account_type" id="account_type" value="<?= $account_type[0]->account_type ?>" class="form-control" placeholder="account_type">
                                                    </div>
                                                </div>
                                            </div>

                                            <input type="hidden" name="account_type_id" value="<?= $account_type[0]->account_type_id ?>" />

                                            <div class="form-group">
                                                <div class="col-md-4 col-sm-0"></div>
                                                <button class="btn btn-alt btn-hover btn-blue-alt col-md-4" onclick="return ConfirmEdit();">
                                                    <span>CONFIRM EDIT ACCOUNT TYPE</span>
                                                    <i class="glyph-icon icon-arrow-right"></i>
                                                </button>
                                                <div class="col-md-4 col-sm-0"></div>
                                            </div>
