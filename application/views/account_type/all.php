...
<html  lang="en">
    ...
    <head>
        ...
        <!--[if IE]><meta http-equiv='X-UA-Compatible' content='IE=edge,chrome=1'><![endif]-->
          <title> Facteezo: Account Type </title>
...
<!--<link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/widgets/datatable/datatable.css">-->
            ...
            $(document).ready(function () {
                $('.dataTables_filter input').attr("placeholder", "Search...");
                            ...
                            <div id="page-title" style="overflow: hidden;">
                                <div class="col-md-6">
                                    <h2>Account Type</h2>
                                    <p>Add, Edit or Delete Account Type</p>
                                </div>
                                <div class="col-md-6">
                                    <button class="btn btn-blue-alt pull-right" onclick="AddUser();"><span style="margin-right: 5px;" class="glyph-icon icon-plus"></span>Add Account Type</button>
                                </div>
                            </div>
                                        ...
                                        <table id="datatable-responsive" class="table table-striped table-bordered responsive no-wrap" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                <?php foreach ($account_type as $account_type) {
                                                    ?>
                                                    <tr>
                                                        <td><?= $account_type->account_type_id ?></td>
                                                        <td><?= $account_type->account_type ?></td>

                                                        <td>
                                                    <?php if($this->session->userdata('user_group_id') == 1){ ?>
                                                            <button class="btn btn-round btn-info" data-toggle="tooltip" data-placement="top" title="Edit" data-toggle="modal" data-target="#myModal" onclick="EditProductCategory('<?= $account_type->account_type_id ?>');">
                                                                <i class="glyph-icon icon-pencil"></i>
                                                            </button>
                                                            <button class="btn btn-round btn-danger" data-toggle="tooltip" data-placement="top" title="Delete" onclick="DeleteProductCategory('<?= $account_type->account_type_id ?>');">
            ...
            <script>
                                                            function EditProductCategory(account_type_id) {
                                                                window.location.href = "<?= base_url() ?>account_type/view/" + account_type_id;
                                                            ...
                                                            function DeleteProductCategory(account_type_id) {
                                                                var cnfirm = confirm("Are You Sure?");
                                                                if (cnfirm) {
                                                                    $.post("<?= base_url() ?>account_type/delete", {id: account_type_id})
                                                                            .done(function (data) {
//                                                                                    alert(data);
                                                                                if ($.trim(data) == 'done') {
                                                            ...
                                                            function AddUser() {
                                                                window.location.href = "<?= base_url() ?>account_type/add";
                                                            }
