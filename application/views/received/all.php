...
//                $('.dataTables_filter input').attr("placeholder", "Search...");
                            ...
                            <div class="panel">
                                <div class="panel-body">
                                    <div class="row ">
                                        <a href="<?= base_url() ?>Received"><h3 class="title-hero col-md-9">
                                                All Received Slips
                                            </h3></a>
                                                ...
                                                foreach ($issues as $issue):
                                                    ...
                                                    <tr >
                                                        ...
                                                        <?php if($this->session->userdata('user_group_id') == 1){ ?>    
                                                            ...
                                                            <button style="display:none;" data-toggle="tooltip" data-placement="top" title="Delete" class="btn btn-round btn-danger" onclick="DeleteIssue('<?= $issue['issue_id'] ?>');">
            ...
            <script>
                                                        function EditIssue(issue_id) {
                                                            window.location.href = "<?= base_url() ?>received/view/" + issue_id;
                ...
                $("#search").keyup(function (event) {
                    ...
                    if (keycode == '13') {
                        ...
                        if (rtngPtId == "") {
                            ...
                            $.post("<?= base_url() ?>Received/search", {id: rtngPtId})
                                    .done(function (data) {
