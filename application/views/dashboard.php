...
<html  lang="en">
    <head>
        ...
        <title> Facteezo: Dashboard </title>
...
<script type="text/javascript" src="<?= base_url() ?>assets/widgets/charts/chart-js/chart-core.js"></script>

<script type="text/javascript" src="<?= base_url() ?>assets/widgets/charts/chart-js/chart-bar.js"></script>
<script type="text/javascript" src="<?= base_url() ?>assets/widgets/charts/chart-js/chart-doughnut.js"></script>
<script type="text/javascript" src="<?= base_url() ?>assets/widgets/charts/chart-js/chart-line.js"></script>
<script type="text/javascript" src="<?= base_url() ?>assets/widgets/charts/chart-js/chart-polar.js"></script>
<script type="text/javascript" src="<?= base_url() ?>assets/widgets/charts/chart-js/chart-radar.js"></script>
...
if (!empty($SALEDATA)) {
    foreach ($SALEDATA as $data) {
        ?>
                                    <?php echo "'".date('j M Y',strtotime($data['date_created']))."'"; ?>,
        <?php
        $c++;
    }
} else {
...
'silver', 'teal', 'white', 'yellow', 'black'];
    var polarData = [
        ...
        <?php $c=1; if (!empty($PRODUCTIONDATA)) {
...
if($DISTPRO !== NULL){
    ?>
 var colors= ['#F7464A','#46BFBD', 'blue', 'fuchsia', 'gray', 'green', 
'lime', 'maroon', 'navy', 'olive', 'orange', 'purple', 'red', 
'silver', 'teal', 'white', 'yellow', 'black'];
var highlight=['white'];
    var doughnutData = [
      <?php $c = 0; if (!empty($TOP5)) {
    foreach ($TOP5 as $data) { ?>
                           
                    {
                        value: <?php echo $data["subtotal"]; ?>,
                        color: colors[<?php echo $c; ?>],
                        highlight: highlight[0],
                        label: '<?php echo $data["product_name"] ?>'
                    },
    <?php $c++;}
} ?>
                ...
                <div id="page-content-wrapper">
                    <div id="page-content">
                        <div class="container">
                            <div id="page-title">
                                <h2><b>Dashboard</b></h2>
                                <p><b>Checkout Latest Updates with Shortcuts Listed.</b></p>
                            ...
                            <div class="panel">
                                <div class="panel-body">
                                    ...
                                    <div class="example-box-wrapper">
										...
										?>
                                            <div class="col-md-2">
                                                <a href="<?= base_url() ?>products" title="Products" class="tile-box tile-box-shortcut btn-primary">
                                            ...
                                            <div class="col-md-2">
                                                <a href="<?= base_url() ?>sale" title="Sales" class="tile-box tile-box-shortcut btn-black">
                                            ...
                                            <div class="col-md-2">
                                                <a href="<?= base_url() ?>purchase" title="Purchases" class="tile-box tile-box-shortcut btn-danger">
                                            ...
                                            <div class="col-md-2">
                                                <a href="<?= base_url() ?>issue" title="Issue Slips" class="tile-box tile-box-shortcut btn-success">
                                                    <div class="tile-header">
                                                        Issue Slips
                                                    </div>
                                                    <div class="tile-content-wrapper">
                                            ...
                                            <div class="col-md-2">
                                                <a href="<?= base_url() ?>production" title="Production" class="tile-box tile-box-shortcut btn-info">
                                            ...
                                            <div class="col-md-2">
                                                <a href="<?= base_url() ?>journal" title="Journal" class="tile-box tile-box-shortcut btn-warning">
                                                    <div class="tile-header">
                                                        Journal
                                                    </div>
                                                    <div class="tile-content-wrapper">
										...
										?>
										                                            <div class="col-md-6">
                                                <a href="<?= base_url() ?>sale" title="Example tile shortcut" class="tile-box tile-box-shortcut btn-black">
											 ...
											 <div class="col-md-6">
                                                <a href="<?= base_url() ?>production" title="Example tile shortcut" class="tile-box tile-box-shortcut btn-info">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="panel">
                                        <div class="panel-body">
                                            <h4 class="title-hero">
                                                <b>
                                                Sale Graph <label>:</label>
                                                <?php echo date("01 M Y") . " t0 " . date("t M Y") ?>
                                                </b>
                                            </h4>
                                            <div class="example-box-wrapper">
                                                <p ><b><i>Max. Amount</i></b></p>
                                                <canvas id="canvas-2" height="450" width="600">  </canvas>
                                                <p style="text-align: center;"><b><i>Date</i></b></p>
                                            </div>
                                        </div>
                                    </div>
                            </div>
                                    ...
                                    <div class="panel">
                                        <div class="panel-body">
                                            <h4 class="title-hero">
                                                <b>
                                               Purchase Graph <label>:</label>
                                               <?php echo date("01 M Y") . " t0 " . date("t M Y") ?>
                                                </b>
                                            </h4>
                                            <div class="example-box-wrapper">
                                                <p ><b><i>Max. Amount</i></b></p>
                                                <canvas id="canvas-3" height="450" width="600"></canvas>
                                                <p style="text-align: center;"><b><i>Date</i></b></p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="panel">
                                        <div class="panel-body">
                                            <h4 class="title-hero">
                                                <b>
                                               Production Graph : <?php echo date("01 M Y") . " to " . date("t M Y") ?>
                                                </b>
                                            </h4>
                                            <div class="example-box-wrapper">
                                                <canvas id="canvas-4" height="450" width="600"></canvas>
                                            </div>
                                        </div>
                                    </div>
                            </div>
                                    ...
                                    <div class="panel">
                                        <div class="panel-body">
                                            <h4 class="title-hero">
                                                <b>
                                                Top 5 Sale Product Graph : <?php echo date("01 M Y") . " to " . date("t M Y") ?>
                                                </b>
                                            </h4>
                                            <div class="example-box-wrapper">
                                                 <canvas id="canvas-5" height="450" width="600"></canvas>
                                            </div>
                                        </div>
                                    </div>
                            </div>
