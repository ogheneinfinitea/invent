...
<!--<link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/widgets/chosen/chosen.css">-->
            ...
            // });
                            ...
                            <div id="page-title">
                                <h2>Edit Purchase</h2>
                                <p>Edit Required information for Purchase</p>
                            ...
                            <div class="panel">
                                <div class="panel-body">
                                    ...
                                    <div class="example-box-wrapper">
                                        <form method="post" action="<?= base_url() ?>purchase/edit" id="SubmitAdd" class="form-horizontal bordered-row">
...
//                echo $key . "<br>";
                                                        ...
                                                        $html .= '</select></div>';
                                                        $html .= '</div><div class="col-sm-2"><div id="div_qty' . $id . '" class="input-group"><input step=".01" type="number" name="qty[]" value="' . $inv_item->qty . '" id="qty' . $id . '" onkeyup="CalculateSubTotal(' . $id . ');"  class="form-control" placeholder="Qty"><span class="input-group-addon bootstrap-touchspin-postfix">' . $unit . '</span></div></div>';
                                                        ...
                                                        $html .= '<div class="col-sm-2"><div id="div_discount' . $id . '" class="input-group"><input type="number" onblur="setTwoNumberDecimal(this.id)" step="0.01" onkeydown="checkTabPress(event);" onkeyup="CalculateSubTotal(' . $id . ');"  name="discount[]" id="discount' . $id . '" value="' . $inv_item->discount . '" class="form-control discount" placeholder="Discount"><span class="input-group-addon bootstrap-touchspin-postfix">Rs</span></div></div>';
                                                        $html .= '<div class="col-sm-2"><div class="input-group"><input type="number" readonly="" onblur="setTwoNumberDecimal(this.id)" step="0.01" name="sub_total[]" id="sub_total' . $id . '" class="form-control sub_total" value="' . $inv_item->invoice_subtotal . '" placeholder="Sub Total"></div></div>';
...
//                                                    alert('hello');
                                                ...
                                                function add_product() {
                                                    ...
                                                    html += '</div><div class="col-sm-2"><div id="div_qty' + id + '" class="input-group"><input type="number" name="qty[]" id="qty' + id + '" class="form-control" placeholder="Qty"></div></div>';
...
//                                                    alert($("#product_name" + id).next("div").children("a").text());
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-2">
                                                    <input  type="text" name="bilty_no" value="<?= $invoice[0]->builty_no ?>" id="bilty_no" class="form-control" placeholder="Enter Bilty No">
                                                </div>
                                                <label class="col-sm-2 control-label">Puchase Voucher No</label>
                                                <div class="col-sm-2">
                                                    <input  type="text" name="pv_no" value="<?= $invoice[0]->voucher_no ?>" id="pv_no" class="form-control" Readonly="">
                                                </div>
                                            </div>
                                            <div class="form-group">
