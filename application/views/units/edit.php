                            ...
                            <div class="panel">
                                <div class="panel-body">
                                    ...
                                    <div class="example-box-wrapper">
                                        <form method="post" action="<?= base_url() ?>units/edit" id="SubmitEdit" class="form-horizontal bordered-row">
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label">Unit Name</label>
                                                <div class="col-sm-6">
                                                    <div class="input-group">
                                                        <span class="input-group-addon glyph-icon icon-circle-o"></span>
                                                        <input type="text" name="name" id="name" value="<?= $unit[0]->unit_name ?>" class="form-control" placeholder="Unit Name">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="symbol" id="symbol" value="<?= $unit[0]->unit_symbol ?>" class="form-control" placeholder="Symbol">
                                                    </div>
                                                </div>
                                            </div>
